...
function copy_nextcloud_app_svg() {
  id="$1"
  path="$2"
  target="packages/harbour/assets/apps/$id.svg"
...
(
  ...
  # Harbour logo
  wget https://raw.githubusercontent.com/Templarian/MaterialDesign/master/svg/ferry.svg -O assets/logo_harbour.svg
  sed -i "s/<path /<path fill=\"$color\" /g" assets/logo_harbour.svg

  # Splash screens
  inkscape assets/logo_harbour.svg -o assets/splash_icon.png -w 768 -h 768 # 768px at xxxhdpi is 192dp
  ...
  export_mipmap_icon_all "assets/logo_harbour.svg" "ic_launcher" &
