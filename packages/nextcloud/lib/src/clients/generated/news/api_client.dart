...
class ApiClient extends BaseApiClient {
  ApiClient({this.basePath = 'https://localhost:8080/apps/news', this.authentication});
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable = false}) {
    try {
      switch (targetType) {
        ...
        case 'NewsFolder':
          return NewsFolder.fromJson(value);
        case 'NewsListArticles':
          return NewsListArticles.fromJson(value);
        case 'NewsListFeeds':
