...
class ApiClient extends BaseApiClient {
  ApiClient({this.basePath = 'https://localhost:8080/ocs/v1.php/cloud', this.authentication});
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable = false}) {
    try {
      switch (targetType) {
        ...
        case 'ProvisioningApiUser':
          return ProvisioningApiUser.fromJson(value);
        case 'ProvisioningApiUserDetails':
          return ProvisioningApiUserDetails.fromJson(value);
        case 'ProvisioningApiUserDetailsBackendCapabilities':
          return ProvisioningApiUserDetailsBackendCapabilities.fromJson(value);
        case 'ProvisioningApiUserDetailsQuota':
          return ProvisioningApiUserDetailsQuota.fromJson(value);
        case 'ProvisioningApiUserOcs':
          return ProvisioningApiUserOcs.fromJson(value);
        default:
          dynamic match;
