...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ApiGetResponseApplicationJson, void>> $get({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<ApiGetResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
  ...
  _i1.DynamiteSerializer<ApiSetResponseApplicationJson, void>
      $$set_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $$set_Request({
    ...
    final _parameters = <String, Object?>{};
    final $dueDate = _$jsonSerializers.serialize(
      dueDate,
      specifiedType: const FullType(String),
    );
    ...
    final _path = _i5.UriTemplate(
      '/ocs/v2.php/apps/files_reminders/api/v{version}/{fileId}{?dueDate*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ApiSetResponseApplicationJson, void>> $set({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<ApiSetResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  _i1.DynamiteSerializer<ApiRemoveResponseApplicationJson, void>
      $remove_Serializer() => _i1.DynamiteSerializer(
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ApiRemoveResponseApplicationJson, void>> remove({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<ApiRemoveResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
...
abstract class ApiGetResponseApplicationJson_Ocs_Data
    implements
        ...
        Built<ApiGetResponseApplicationJson_Ocs_Data,
  ...
  factory ApiGetResponseApplicationJson_Ocs_Data([
    void Function(ApiGetResponseApplicationJson_Ocs_DataBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGetResponseApplicationJson_Ocs_Data.fromJson(
...
abstract class ApiGetResponseApplicationJson_Ocs
    implements
        ...
        Built<ApiGetResponseApplicationJson_Ocs,
            ApiGetResponseApplicationJson_OcsBuilder> {
  /// Creates a new ApiGetResponseApplicationJson_Ocs object using the builder pattern.
  factory ApiGetResponseApplicationJson_Ocs([
    void Function(ApiGetResponseApplicationJson_OcsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGetResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ApiGetResponseApplicationJson
    implements
        ...
        Built<ApiGetResponseApplicationJson,
            ApiGetResponseApplicationJsonBuilder> {
  /// Creates a new ApiGetResponseApplicationJson object using the builder pattern.
  factory ApiGetResponseApplicationJson([
    void Function(ApiGetResponseApplicationJsonBuilder)? b,
  ...
  static Serializer<ApiGetResponseApplicationJson> get serializer =>
...
abstract class ApiSetResponseApplicationJson_Ocs
    implements
        ...
        Built<ApiSetResponseApplicationJson_Ocs,
            ApiSetResponseApplicationJson_OcsBuilder> {
  /// Creates a new ApiSetResponseApplicationJson_Ocs object using the builder pattern.
  factory ApiSetResponseApplicationJson_Ocs([
    void Function(ApiSetResponseApplicationJson_OcsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiSetResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ApiSetResponseApplicationJson
    implements
        ...
        Built<ApiSetResponseApplicationJson,
            ApiSetResponseApplicationJsonBuilder> {
  /// Creates a new ApiSetResponseApplicationJson object using the builder pattern.
  factory ApiSetResponseApplicationJson([
    void Function(ApiSetResponseApplicationJsonBuilder)? b,
  ...
  static Serializer<ApiSetResponseApplicationJson> get serializer =>
...
abstract class ApiRemoveResponseApplicationJson_Ocs
    implements
        ...
        Built<ApiRemoveResponseApplicationJson_Ocs,
  ...
  factory ApiRemoveResponseApplicationJson_Ocs([
    void Function(ApiRemoveResponseApplicationJson_OcsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiRemoveResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ApiRemoveResponseApplicationJson
    implements
        ...
        Built<ApiRemoveResponseApplicationJson,
            ApiRemoveResponseApplicationJsonBuilder> {
  /// Creates a new ApiRemoveResponseApplicationJson object using the builder pattern.
  factory ApiRemoveResponseApplicationJson([
    void Function(ApiRemoveResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiRemoveResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
final Serializers _$serializers = (Serializers().toBuilder()
      ..addBuilderFactory(
        const FullType(ApiGetResponseApplicationJson),
        ApiGetResponseApplicationJsonBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(ApiSetResponseApplicationJson),
        ApiSetResponseApplicationJsonBuilder.new,
      )
