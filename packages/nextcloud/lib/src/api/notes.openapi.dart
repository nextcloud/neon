...
class $Client extends _i1.DynamiteClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<BuiltList<Note>, void> $getNotes_Serializer() =>
  ...
  _i3.Request $getNotes_Request({
    ...
    final $category = _$jsonSerializers.serialize(
      category,
      specifiedType: const FullType(String),
    );
    _parameters['category'] = $category;

    var $exclude = _$jsonSerializers.serialize(
      exclude,
      specifiedType: const FullType(String),
    );
    $exclude ??= '';
    ...
    var $pruneBefore = _$jsonSerializers.serialize(
      pruneBefore,
    ...
    var $chunkSize = _$jsonSerializers.serialize(
      chunkSize,
      specifiedType: const FullType(int),
    );
    $chunkSize ??= 0;
    ...
    final $chunkCursor = _$jsonSerializers.serialize(
      chunkCursor,
      specifiedType: const FullType(String),
    );
...
// coverage:ignore-end
    final $ifNoneMatch = _$jsonSerializers.serialize(
      ifNoneMatch,
      specifiedType: const FullType(String),
    );
    if ($ifNoneMatch != null) {
      _request.headers['If-None-Match'] =
          const _i5.HeaderEncoder().convert($ifNoneMatch);
    }
  ...
  Future<_i1.DynamiteResponse<BuiltList<Note>, void>> getNotes({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<BuiltList<Note>, void>(_serializer)
            .convert(_response);
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Note, void> $createNote_Serializer() =>
      _i1.DynamiteSerializer(
  ...
  _i3.Request $createNote_Request({
    ...
    final _parameters = <String, Object?>{};
    var $category = _$jsonSerializers.serialize(
      category,
      specifiedType: const FullType(String),
    );
    $category ??= '';
    ...
    var $title = _$jsonSerializers.serialize(
      title,
      specifiedType: const FullType(String),
    );
    $title ??= '';
    ...
    var $content = _$jsonSerializers.serialize(
      content,
      specifiedType: const FullType(String),
    );
    $content ??= '';
    ...
    var $modified = _$jsonSerializers.serialize(
      modified,
      specifiedType: const FullType(int),
    );
    $modified ??= 0;
    ...
    var $favorite = _$jsonSerializers.serialize(
      favorite,
      specifiedType: const FullType(int),
    );
    $favorite ??= 0;
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<Note, void>> createNote({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<Note, void>(_serializer).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }

  /// Builds a serializer to parse the response of [$getNote_Request].
  @_i2.experimental
  _i1.DynamiteSerializer<Note, void> $getNote_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: const FullType(Note),
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $getNote_Request({
    ...
    final _path =
        _i4.UriTemplate('/index.php/apps/notes/api/v1/notes/{id}{?exclude*}')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i3.Request('get', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Note, void> $updateNote_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: const FullType(Note),
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $updateNote_Request({
    ...
    final $content = _$jsonSerializers.serialize(
      content,
      specifiedType: const FullType(String),
    );
    _parameters['content'] = $content;

    final $modified = _$jsonSerializers.serialize(
      modified,
      specifiedType: const FullType(int),
    );
    _parameters['modified'] = $modified;

    final $title = _$jsonSerializers.serialize(
      title,
      specifiedType: const FullType(String),
    );
    _parameters['title'] = $title;
    ...
    final $favorite = _$jsonSerializers.serialize(
      favorite,
      specifiedType: const FullType(int),
    );
    _parameters['favorite'] = $favorite;
...
// coverage:ignore-end
    final $ifMatch = _$jsonSerializers.serialize(
      ifMatch,
      specifiedType: const FullType(String),
    );
    if ($ifMatch != null) {
      _request.headers['If-Match'] =
          const _i5.HeaderEncoder().convert($ifMatch);
    }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<String, void> $deleteNote_Serializer() =>
      _i1.DynamiteSerializer(
  ...
  _i3.Request $deleteNote_Request({required int id}) {
    ...
    final _path = _i4.UriTemplate('/index.php/apps/notes/api/v1/notes/{id}')
        .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<String, void>> deleteNote({
    required int id,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Settings, void> $getSettings_Serializer() =>
      _i1.DynamiteSerializer(
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<Settings, void>> getSettings() async {
    ...
    final _rawResponse =
        await _i1.ResponseConverter<Settings, void>(_serializer)
            .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Settings, void> $updateSettings_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: const FullType(Settings),
        headersType: null,
        serializers: _$jsonSerializers,
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<Settings, void>> updateSettings({
...
class Settings_NoteMode extends EnumClass {
  ...
  static Settings_NoteMode valueOf(String name) =>
      _$valueOfSettings_NoteMode(name);
  ...
  static Serializer<Settings_NoteMode> get serializer =>
      const _$Settings_NoteModeSerializer();
}

class _$Settings_NoteModeSerializer
    implements PrimitiveSerializer<Settings_NoteMode> {
  const _$Settings_NoteModeSerializer();

  static const Map<Settings_NoteMode, Object> _toWire =
  ...
  static const Map<Object, Settings_NoteMode> _fromWire =
      <Object, Settings_NoteMode>{
...
abstract class Settings
    implements $SettingsInterface, Built<Settings, SettingsBuilder> {
...
abstract class Capabilities_Notes
    implements
        $Capabilities_NotesInterface,
        Built<Capabilities_Notes, Capabilities_NotesBuilder> {
  /// Creates a new Capabilities_Notes object using the builder pattern.
  factory Capabilities_Notes([void Function(Capabilities_NotesBuilder)? b]) =
      _$Capabilities_Notes;
  ...
  static Serializer<Capabilities_Notes> get serializer =>
      _$capabilitiesNotesSerializer;
}
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..add(Note.serializer)
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(Note)]),
        ListBuilder<Note>.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(Capabilities_Notes),
        Capabilities_NotesBuilder.new,
      )
