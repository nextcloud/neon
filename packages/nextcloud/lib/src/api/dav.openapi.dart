...
class $DirectClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<DirectGetUrlResponseApplicationJson, void>
      $getUrl_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $getUrl_Request({
    ...
    final $expirationTime = _$jsonSerializers.serialize(
      expirationTime,
    ...
    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/dav/api/v1/direct{?fileId*,expirationTime*}',
    ).expand(_parameters);
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<DirectGetUrlResponseApplicationJson, void>>
      getUrl({
    required int fileId,
    required int expirationTime,
    bool? oCSAPIRequest,
    ...
    final _rawResponse =
        await _i1.ResponseConverter<DirectGetUrlResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
...
class $OutOfOfficeClient {
  ...
  _i1.DynamiteSerializer<
          OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson, void>
  ...
  _i3.Request $getCurrentOutOfOfficeData_Request({
    ...
    final _path =
        _i4.UriTemplate('/ocs/v2.php/apps/dav/api/v1/outOfOffice/{userId}/now')
            .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<
          OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson,
          void>> getCurrentOutOfOfficeData({
    required String userId,
    bool? oCSAPIRequest,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<OutOfOfficeGetOutOfOfficeResponseApplicationJson, void>
      $getOutOfOffice_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(
  ...
  _i3.Request $getOutOfOffice_Request({
    ...
    final _path =
        _i4.UriTemplate('/ocs/v2.php/apps/dav/api/v1/outOfOffice/{userId}')
            .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('get', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<OutOfOfficeGetOutOfOfficeResponseApplicationJson,
          void>> getOutOfOffice({
    required String userId,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            OutOfOfficeGetOutOfOfficeResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<OutOfOfficeSetOutOfOfficeResponseApplicationJson, void>
      $setOutOfOffice_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(
  ...
  _i3.Request $setOutOfOffice_Request({
    ...
    final _parameters = <String, Object?>{};
    final $firstDay = _$jsonSerializers.serialize(
      firstDay,
      specifiedType: const FullType(String),
    );
    _parameters['firstDay'] = $firstDay;

    final $lastDay = _$jsonSerializers.serialize(
      lastDay,
      specifiedType: const FullType(String),
    );
    ...
    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/dav/api/v1/outOfOffice/{userId}{?firstDay*,lastDay*,status*,message*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<OutOfOfficeSetOutOfOfficeResponseApplicationJson,
          void>> setOutOfOffice({
    required String firstDay,
    required String lastDay,
    required String status,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            OutOfOfficeSetOutOfOfficeResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<
          OutOfOfficeClearOutOfOfficeResponseApplicationJson, void>
      $clearOutOfOffice_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<OutOfOfficeClearOutOfOfficeResponseApplicationJson,
          void>> clearOutOfOffice({
    required String userId,
    bool? oCSAPIRequest,
  }) async {
...
abstract class DirectGetUrlResponseApplicationJson_Ocs_Data
    implements
        ...
        Built<DirectGetUrlResponseApplicationJson_Ocs_Data,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectGetUrlResponseApplicationJson_Ocs_Data.fromJson(
  ...
  static Serializer<DirectGetUrlResponseApplicationJson_Ocs_Data>
      get serializer => _$directGetUrlResponseApplicationJsonOcsDataSerializer;
}
...
abstract class DirectGetUrlResponseApplicationJson_Ocs
    implements
        ...
        Built<DirectGetUrlResponseApplicationJson_Ocs,
  ...
  factory DirectGetUrlResponseApplicationJson_Ocs([
    void Function(DirectGetUrlResponseApplicationJson_OcsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectGetUrlResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class DirectGetUrlResponseApplicationJson
    implements
        ...
        Built<DirectGetUrlResponseApplicationJson,
  ...
  factory DirectGetUrlResponseApplicationJson([
    void Function(DirectGetUrlResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectGetUrlResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class OutOfOfficeDataCommon
    implements
        $OutOfOfficeDataCommonInterface,
        Built<OutOfOfficeDataCommon, OutOfOfficeDataCommonBuilder> {
  /// Creates a new OutOfOfficeDataCommon object using the builder pattern.
  factory OutOfOfficeDataCommon([
    void Function(OutOfOfficeDataCommonBuilder)? b,
  ...
  static Serializer<OutOfOfficeDataCommon> get serializer =>
...
abstract class CurrentOutOfOfficeData
    implements
        $CurrentOutOfOfficeDataInterface,
        Built<CurrentOutOfOfficeData, CurrentOutOfOfficeDataBuilder> {
  /// Creates a new CurrentOutOfOfficeData object using the builder pattern.
  factory CurrentOutOfOfficeData([
    void Function(CurrentOutOfOfficeDataBuilder)? b,
  ...
  static Serializer<CurrentOutOfOfficeData> get serializer =>
...
abstract class OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson>
      get serializer =>
...
abstract class OutOfOfficeData
    implements
        $OutOfOfficeDataInterface,
        Built<OutOfOfficeData, OutOfOfficeDataBuilder> {
  /// Creates a new OutOfOfficeData object using the builder pattern.
  factory OutOfOfficeData([void Function(OutOfOfficeDataBuilder)? b]) =
      _$OutOfOfficeData;
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeData.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OutOfOfficeData> get serializer =>
...
abstract class OutOfOfficeGetOutOfOfficeResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeGetOutOfOfficeResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OutOfOfficeGetOutOfOfficeResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class OutOfOfficeGetOutOfOfficeResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeGetOutOfOfficeResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OutOfOfficeGetOutOfOfficeResponseApplicationJson>
      get serializer =>
...
abstract class OutOfOfficeSetOutOfOfficeResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeSetOutOfOfficeResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OutOfOfficeSetOutOfOfficeResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class OutOfOfficeSetOutOfOfficeResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeSetOutOfOfficeResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OutOfOfficeSetOutOfOfficeResponseApplicationJson>
      get serializer =>
...
abstract class OutOfOfficeClearOutOfOfficeResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeClearOutOfOfficeResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OutOfOfficeClearOutOfOfficeResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class OutOfOfficeClearOutOfOfficeResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OutOfOfficeClearOutOfOfficeResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OutOfOfficeClearOutOfOfficeResponseApplicationJson>
      get serializer =>
...
abstract class Capabilities_Dav
    implements
        $Capabilities_DavInterface,
        Built<Capabilities_Dav, Capabilities_DavBuilder> {
  /// Creates a new Capabilities_Dav object using the builder pattern.
  factory Capabilities_Dav([void Function(Capabilities_DavBuilder)? b]) =
      _$Capabilities_Dav;
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Capabilities_Dav.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<Capabilities_Dav> get serializer =>
      _$capabilitiesDavSerializer;
}
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..add(
        OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson.serializer,
      )
      ..addBuilderFactory(
        const FullType(
          OutOfOfficeGetCurrentOutOfOfficeDataResponseApplicationJson_Ocs,
      ...
      ..addBuilderFactory(
        const FullType(CurrentOutOfOfficeData),
        CurrentOutOfOfficeDataBuilder.new,
      )
      ..add(CurrentOutOfOfficeData.serializer)
      ..addBuilderFactory(
        const FullType(OutOfOfficeDataCommon),
        OutOfOfficeDataCommonBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(OutOfOfficeData),
        OutOfOfficeDataBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(Capabilities_Dav),
        Capabilities_DavBuilder.new,
      )
