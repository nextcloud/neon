...
class $ApiClient {
  ...
  _i1.DynamiteSerializer<ApiGetAppListResponseApplicationJson, void>
      $getAppList_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $getAppList_Request({
    ...
    final $newVersion = _$jsonSerializers.serialize(
      newVersion,
    ...
    var $apiVersion = _$jsonSerializers.serialize(
      apiVersion,
      specifiedType: const FullType(ApiGetAppListApiVersion),
    );
    $apiVersion ??= 'v1';
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ApiGetAppListResponseApplicationJson, void>>
      getAppList({
    required String newVersion,
    ApiGetAppListApiVersion? apiVersion,
    bool? oCSAPIRequest,
    ...
    final _rawResponse =
        await _i1.ResponseConverter<ApiGetAppListResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
...
class ApiGetAppListApiVersion extends EnumClass {
  ...
  // coverage:ignore-start
  static BuiltSet<ApiGetAppListApiVersion> get values =>
      _$apiGetAppListApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static ApiGetAppListApiVersion valueOf(String name) =>
      _$valueOfApiGetAppListApiVersion(name);
  ...
  static Serializer<ApiGetAppListApiVersion> get serializer =>
      const _$ApiGetAppListApiVersionSerializer();
}

class _$ApiGetAppListApiVersionSerializer
    implements PrimitiveSerializer<ApiGetAppListApiVersion> {
  const _$ApiGetAppListApiVersionSerializer();

  static const Map<ApiGetAppListApiVersion, Object> _toWire =
      <ApiGetAppListApiVersion, Object>{
    ApiGetAppListApiVersion.v1: 'v1',
  };

  static const Map<Object, ApiGetAppListApiVersion> _fromWire =
      <Object, ApiGetAppListApiVersion>{
...
abstract class ApiGetAppListResponseApplicationJson_Ocs_Data
    implements
        ...
        Built<ApiGetAppListResponseApplicationJson_Ocs_Data,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGetAppListResponseApplicationJson_Ocs_Data.fromJson(
  ...
  static Serializer<ApiGetAppListResponseApplicationJson_Ocs_Data>
      get serializer => _$apiGetAppListResponseApplicationJsonOcsDataSerializer;
}
...
abstract class ApiGetAppListResponseApplicationJson_Ocs
    implements
        ...
        Built<ApiGetAppListResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGetAppListResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ApiGetAppListResponseApplicationJson
    implements
        ...
        Built<ApiGetAppListResponseApplicationJson,
  ...
  factory ApiGetAppListResponseApplicationJson([
    void Function(ApiGetAppListResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGetAppListResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
