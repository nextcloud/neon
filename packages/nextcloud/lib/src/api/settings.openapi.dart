...
class $LogSettingsClient {
  ...
  _i1.DynamiteSerializer<Uint8List, LogSettingsLogSettingsDownloadHeaders>
      $download_Serializer() => _i1.DynamiteSerializer(
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<Uint8List, LogSettingsLogSettingsDownloadHeaders>>
      download() async {
    ...
    final _rawResponse = await _i1.ResponseConverter<Uint8List,
            LogSettingsLogSettingsDownloadHeaders>(_serializer)
        .convert(_response);
...
abstract class LogSettingsLogSettingsDownloadHeaders
    implements
        ...
        Built<LogSettingsLogSettingsDownloadHeaders,
  ...
  factory LogSettingsLogSettingsDownloadHeaders([
    void Function(LogSettingsLogSettingsDownloadHeadersBuilder)? b,
  ...
  // coverage:ignore-start
  factory LogSettingsLogSettingsDownloadHeaders.fromJson(
