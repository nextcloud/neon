...
class $Client extends _i1.DynamiteClient {
  ...
  _i1.DynamiteSerializer<SupportedAPIVersions, void>
      $getSupportedApiVersions_Serializer() => _i1.DynamiteSerializer(
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<SupportedAPIVersions, void>>
      getSupportedApiVersions() async {
    ...
    final _rawResponse =
        await _i1.ResponseConverter<SupportedAPIVersions, void>(_serializer)
            .convert(_response);
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<ListFolders, void> $listFolders_Serializer() =>
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ListFolders, void>> listFolders() async {
    ...
    final _rawResponse =
        await _i1.ResponseConverter<ListFolders, void>(_serializer)
            .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<ListFolders, void> $createFolder_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: const FullType(ListFolders),
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $createFolder_Request({required String name}) {
    ...
    final _path =
        _i4.UriTemplate('/index.php/apps/news/api/v1-3/folders{?name*}')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ListFolders, void>> createFolder({
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $renameFolder_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $renameFolder_Request({
    ...
    final _parameters = <String, Object?>{};
    final $folderId = _$jsonSerializers.serialize(
      folderId,
    ...
    final _path = _i4.UriTemplate(
      '/index.php/apps/news/api/v1-3/folders/{folderId}{?name*}',
    ).expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<void, void>> renameFolder({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<void, void>(_serializer).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }

  /// Builds a serializer to parse the response of [$deleteFolder_Request].
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $deleteFolder_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $deleteFolder_Request({required int folderId}) {
    ...
    final _path =
        _i4.UriTemplate('/index.php/apps/news/api/v1-3/folders/{folderId}')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<void, void>> deleteFolder({
    required int folderId,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $markFolderAsRead_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $markFolderAsRead_Request({
    ...
    final $newestItemId = _$jsonSerializers.serialize(
      newestItemId,
      specifiedType: const FullType(int),
    );
...
// coverage:ignore-end
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<ListFeeds, void> $listFeeds_Serializer() =>
      _i1.DynamiteSerializer(
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ListFeeds, void>> listFeeds() async {
    ...
    final _rawResponse =
        await _i1.ResponseConverter<ListFeeds, void>(_serializer)
            .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<ListFeeds, void> $addFeed_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: const FullType(ListFeeds),
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $addFeed_Request({
    ...
    final _parameters = <String, Object?>{};
    final $url =
        _$jsonSerializers.serialize(url, specifiedType: const FullType(String));
    _parameters['url'] = $url;
    ...
    final _path =
        _i4.UriTemplate('/index.php/apps/news/api/v1-3/feeds{?url*,folderId*}')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $deleteFeed_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $deleteFeed_Request({required int feedId}) {
    final _parameters = <String, Object?>{};
    final $feedId =
        _$jsonSerializers.serialize(feedId, specifiedType: const FullType(int));
    _parameters['feedId'] = $feedId;

    final _path =
        _i4.UriTemplate('/index.php/apps/news/api/v1-3/feeds/{feedId}')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i3.Request('delete', _uri);
// coverage:ignore-start
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<void, void>> deleteFeed({
    required int feedId,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $moveFeed_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $moveFeed_Request({
    ...
    final _path = _i4.UriTemplate(
      '/index.php/apps/news/api/v1-3/feeds/{feedId}/move{?folderId*}',
    ).expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i3.Request('post', _uri);
// coverage:ignore-start
...
// coverage:ignore-end
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $renameFeed_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $renameFeed_Request({
    ...
    final $feedTitle = _$jsonSerializers.serialize(
      feedTitle,
      specifiedType: const FullType(String),
    );
...
// coverage:ignore-end
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $markFeedAsRead_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
...
// coverage:ignore-end
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<ListArticles, void> $listArticles_Serializer() =>
      _i1.DynamiteSerializer(
  ...
  _i3.Request $listArticles_Request({
    ...
    final _parameters = <String, Object?>{};
    var $type =
        _$jsonSerializers.serialize(type, specifiedType: const FullType(int));
    $type ??= 3;
    ...
    var $getRead = _$jsonSerializers.serialize(
      getRead,
      specifiedType: const FullType(int),
    );
    $getRead ??= 1;
    ...
    var $batchSize = _$jsonSerializers.serialize(
      batchSize,
      specifiedType: const FullType(int),
    );
    $batchSize ??= -1;
    ...
    var $oldestFirst = _$jsonSerializers.serialize(
      oldestFirst,
      specifiedType: const FullType(int),
    );
    $oldestFirst ??= 0;
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ListArticles, void>> listArticles({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<ListArticles, void>(_serializer)
            .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  _i1.DynamiteSerializer<ListArticles, void>
      $listUpdatedArticles_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(ListArticles),
            headersType: null,
            serializers: _$jsonSerializers,
            validStatuses: const {200},
  ...
  _i3.Request $listUpdatedArticles_Request({
    ...
    var $lastModified = _$jsonSerializers.serialize(
      lastModified,
      specifiedType: const FullType(int),
    );
    $lastModified ??= 0;
...
// coverage:ignore-end
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $markArticleAsRead_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $markArticleAsRead_Request({required int itemId}) {
    final _parameters = <String, Object?>{};
    final $itemId =
        _$jsonSerializers.serialize(itemId, specifiedType: const FullType(int));
    _parameters['itemId'] = $itemId;

    final _path =
        _i4.UriTemplate('/index.php/apps/news/api/v1-3/items/{itemId}/read')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i3.Request('post', _uri);
// coverage:ignore-start
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<void, void>> markArticleAsRead({
    required int itemId,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $markArticleAsUnread_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $markArticleAsUnread_Request({required int itemId}) {
    ...
    final _path =
        _i4.UriTemplate('/index.php/apps/news/api/v1-3/items/{itemId}/unread')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i3.Request('post', _uri);
// coverage:ignore-start
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<void, void>> markArticleAsUnread({
    required int itemId,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $starArticle_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $starArticle_Request({required int itemId}) {
    ...
    final _path =
        _i4.UriTemplate('/index.php/apps/news/api/v1-3/items/{itemId}/star')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i3.Request('post', _uri);
// coverage:ignore-start
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<void, void>> starArticle({
    required int itemId,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $unstarArticle_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $unstarArticle_Request({required int itemId}) {
    ...
    final _path =
        _i4.UriTemplate('/index.php/apps/news/api/v1-3/items/{itemId}/unstar')
            .expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i3.Request('post', _uri);
// coverage:ignore-start
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<void, void>> unstarArticle({
    required int itemId,
  }) async {
...
abstract class SupportedAPIVersions
    implements
        $SupportedAPIVersionsInterface,
        Built<SupportedAPIVersions, SupportedAPIVersionsBuilder> {
  /// Creates a new SupportedAPIVersions object using the builder pattern.
  factory SupportedAPIVersions([
    void Function(SupportedAPIVersionsBuilder)? b,
  ...
  static Serializer<SupportedAPIVersions> get serializer =>
...
abstract class Article
    implements $ArticleInterface, Built<Article, ArticleBuilder> {
...
abstract class Folder
    implements $FolderInterface, Built<Folder, FolderBuilder> {
...
abstract class ListFolders
    implements $ListFoldersInterface, Built<ListFolders, ListFoldersBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ListFolders.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ListFeeds
    implements $ListFeedsInterface, Built<ListFeeds, ListFeedsBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ListFeeds.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ListArticles
    implements
        ...
        Built<ListArticles, ListArticlesBuilder> {
  /// Creates a new ListArticles object using the builder pattern.
  factory ListArticles([void Function(ListArticlesBuilder)? b]) =
      _$ListArticles;
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ListArticles.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class EmptyOCS_Ocs
    implements
        $EmptyOCS_OcsInterface,
        Built<EmptyOCS_Ocs, EmptyOCS_OcsBuilder> {
  /// Creates a new EmptyOCS_Ocs object using the builder pattern.
  factory EmptyOCS_Ocs([void Function(EmptyOCS_OcsBuilder)? b]) =
      _$EmptyOCS_Ocs;
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EmptyOCS_Ocs.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class EmptyOCS
    implements $EmptyOCSInterface, Built<EmptyOCS, EmptyOCSBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EmptyOCS.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
final Serializers _$serializers = (Serializers().toBuilder()
      ..addBuilderFactory(
        const FullType(SupportedAPIVersions),
        SupportedAPIVersionsBuilder.new,
      )
      ...
      ..addBuilderFactory(
        ...
        ListBuilder<Article>.new,
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(Feed)]),
        ListBuilder<Feed>.new,
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(Folder)]),
        ListBuilder<Folder>.new,
      )
