...
abstract class SupportedAPIVersions
  ...
  // coverage:ignore-start
  factory SupportedAPIVersions.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Article implements $ArticleInterface, Built<Article, ArticleBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Article.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Feed implements $FeedInterface, Built<Feed, FeedBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Feed.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Folder implements $FolderInterface, Built<Folder, FolderBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Folder.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ListFolders implements $ListFoldersInterface, Built<ListFolders, ListFoldersBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ListFolders.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ListFeeds implements $ListFeedsInterface, Built<ListFeeds, ListFeedsBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ListFeeds.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class ListArticles implements $ListArticlesInterface, Built<ListArticles, ListArticlesBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ListArticles.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class EmptyOCS_Ocs implements $EmptyOCS_OcsInterface, Built<EmptyOCS_Ocs, EmptyOCS_OcsBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EmptyOCS_Ocs.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class EmptyOCS implements $EmptyOCSInterface, Built<EmptyOCS, EmptyOCSBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EmptyOCS.fromJson(Object json) => _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
