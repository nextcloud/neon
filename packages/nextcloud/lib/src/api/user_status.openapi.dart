...
class $Client extends _i1.DynamiteClient {
  ...
  late final $PredefinedStatusClient predefinedStatus =
      $PredefinedStatusClient(this);
...
class $HeartbeatClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<HeartbeatHeartbeatResponseApplicationJson, void>
      $heartbeat_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $heartbeat_Request({
    ...
    final $status = _$jsonSerializers.serialize(
      status,
    ...
    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/user_status/api/v1/heartbeat{?status*}',
    ).expand(_parameters);
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<HeartbeatHeartbeatResponseApplicationJson, void>>
      heartbeat({
    required String status,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            HeartbeatHeartbeatResponseApplicationJson, void>(_serializer)
        .convert(_response);
...
class $PredefinedStatusClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<PredefinedStatusFindAllResponseApplicationJson, void>
      $findAll_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<PredefinedStatusFindAllResponseApplicationJson,
          void>> findAll({bool? oCSAPIRequest}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            PredefinedStatusFindAllResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
class $StatusesClient {
  ...
  /// Builds a serializer to parse the response of [$findAll_Request].
  @_i2.experimental
  _i1.DynamiteSerializer<StatusesFindAllResponseApplicationJson, void>
      $findAll_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $findAll_Request({
    ...
    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/user_status/api/v1/statuses{?limit*,offset*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('get', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  ///  * [$findAll_Request] for the request send by this method.
  ///  * [$findAll_Serializer] for a converter to parse the `Response` from an executed request.
  Future<_i1.DynamiteResponse<StatusesFindAllResponseApplicationJson, void>>
      findAll({
    int? limit,
    int? offset,
    bool? oCSAPIRequest,
    ...
    final _serializer = $findAll_Serializer();
    final _rawResponse = await _i1.ResponseConverter<
            StatusesFindAllResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<StatusesFindResponseApplicationJson, void>
      $find_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $find_Request({
    ...
    final _path =
        _i4.UriTemplate('/ocs/v2.php/apps/user_status/api/v1/statuses/{userId}')
            .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('get', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<StatusesFindResponseApplicationJson, void>> find({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<StatusesFindResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
...
class $UserStatusClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<UserStatusGetStatusResponseApplicationJson, void>
      $getStatus_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<UserStatusGetStatusResponseApplicationJson, void>>
      getStatus({bool? oCSAPIRequest}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            UserStatusGetStatusResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<UserStatusSetStatusResponseApplicationJson, void>
      $setStatus_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $setStatus_Request({
    ...
    final _parameters = <String, Object?>{};
    final $statusType = _$jsonSerializers.serialize(
      statusType,
      specifiedType: const FullType(String),
    );
    ...
    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/user_status/api/v1/user_status/status{?statusType*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('put', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<UserStatusSetStatusResponseApplicationJson, void>>
      setStatus({
    required String statusType,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            UserStatusSetStatusResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  _i1.DynamiteSerializer<
          UserStatusSetPredefinedMessageResponseApplicationJson, void>
  ...
  _i3.Request $setPredefinedMessage_Request({
    ...
    final _parameters = <String, Object?>{};
    final $messageId = _$jsonSerializers.serialize(
      messageId,
      specifiedType: const FullType(String),
    );
    _parameters['messageId'] = $messageId;

    final $clearAt = _$jsonSerializers.serialize(
      clearAt,
    ...
    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/user_status/api/v1/user_status/message/predefined{?messageId*,clearAt*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('put', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<
          UserStatusSetCustomMessageResponseApplicationJson, void>
      $setCustomMessage_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(
  ...
  _i3.Request $setCustomMessage_Request({
    ...
    final _parameters = <String, Object?>{};
    final $statusIcon = _$jsonSerializers.serialize(
      statusIcon,
      specifiedType: const FullType(String),
    );
    _parameters['statusIcon'] = $statusIcon;

    final $message = _$jsonSerializers.serialize(
      message,
      specifiedType: const FullType(String),
    );
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<UserStatusSetCustomMessageResponseApplicationJson,
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<UserStatusClearMessageResponseApplicationJson, void>
      $clearMessage_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<UserStatusClearMessageResponseApplicationJson,
          void>> clearMessage({bool? oCSAPIRequest}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            UserStatusClearMessageResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<UserStatusRevertStatusResponseApplicationJson, void>
      $revertStatus_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<UserStatusRevertStatusResponseApplicationJson,
          void>> revertStatus({
    required String messageId,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            UserStatusRevertStatusResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
abstract class Public
    implements $PublicInterface, Built<Public, PublicBuilder> {
...
abstract class Private
    implements $PrivateInterface, Built<Private, PrivateBuilder> {
...
abstract class HeartbeatHeartbeatResponseApplicationJson_Ocs
    implements
        ...
        Built<HeartbeatHeartbeatResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory HeartbeatHeartbeatResponseApplicationJson_Ocs.fromJson(
  ...
  static Serializer<HeartbeatHeartbeatResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class HeartbeatHeartbeatResponseApplicationJson
    implements
        ...
        Built<HeartbeatHeartbeatResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory HeartbeatHeartbeatResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
class ClearAt_Type extends EnumClass {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<ClearAt_Type> get serializer =>
...
class ClearAtTimeType extends EnumClass {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<ClearAtTimeType> get serializer =>
      const _$ClearAtTimeTypeSerializer();
}

class _$ClearAtTimeTypeSerializer
    implements PrimitiveSerializer<ClearAtTimeType> {
  const _$ClearAtTimeTypeSerializer();
  ...
  static const Map<Object, ClearAtTimeType> _fromWire =
      <Object, ClearAtTimeType>{
...
abstract class ClearAt
    implements $ClearAtInterface, Built<ClearAt, ClearAtBuilder> {
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ClearAt.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Predefined
    implements $PredefinedInterface, Built<Predefined, PredefinedBuilder> {
...
abstract class PredefinedStatusFindAllResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory PredefinedStatusFindAllResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<PredefinedStatusFindAllResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class PredefinedStatusFindAllResponseApplicationJson
    implements
        ...
        Built<PredefinedStatusFindAllResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory PredefinedStatusFindAllResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<PredefinedStatusFindAllResponseApplicationJson>
      get serializer =>
...
abstract class StatusesFindAllResponseApplicationJson_Ocs
    implements
        ...
        Built<StatusesFindAllResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory StatusesFindAllResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<StatusesFindAllResponseApplicationJson_Ocs>
      get serializer => _$statusesFindAllResponseApplicationJsonOcsSerializer;
}
...
abstract class StatusesFindAllResponseApplicationJson
    implements
        ...
        Built<StatusesFindAllResponseApplicationJson,
  ...
  factory StatusesFindAllResponseApplicationJson([
    void Function(StatusesFindAllResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory StatusesFindAllResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class StatusesFindResponseApplicationJson_Ocs
    implements
        ...
        Built<StatusesFindResponseApplicationJson_Ocs,
  ...
  factory StatusesFindResponseApplicationJson_Ocs([
    void Function(StatusesFindResponseApplicationJson_OcsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory StatusesFindResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class StatusesFindResponseApplicationJson
    implements
        ...
        Built<StatusesFindResponseApplicationJson,
  ...
  factory StatusesFindResponseApplicationJson([
    void Function(StatusesFindResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory StatusesFindResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class UserStatusGetStatusResponseApplicationJson_Ocs
    implements
        ...
        Built<UserStatusGetStatusResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusGetStatusResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusGetStatusResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class UserStatusGetStatusResponseApplicationJson
    implements
        ...
        Built<UserStatusGetStatusResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusGetStatusResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusGetStatusResponseApplicationJson>
      get serializer => _$userStatusGetStatusResponseApplicationJsonSerializer;
}
...
abstract class UserStatusSetStatusResponseApplicationJson_Ocs
    implements
        ...
        Built<UserStatusSetStatusResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusSetStatusResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusSetStatusResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class UserStatusSetStatusResponseApplicationJson
    implements
        ...
        Built<UserStatusSetStatusResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusSetStatusResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusSetStatusResponseApplicationJson>
      get serializer => _$userStatusSetStatusResponseApplicationJsonSerializer;
}
...
abstract class UserStatusSetPredefinedMessageResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusSetPredefinedMessageResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusSetPredefinedMessageResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class UserStatusSetPredefinedMessageResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusSetPredefinedMessageResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusSetPredefinedMessageResponseApplicationJson>
      get serializer =>
...
abstract class UserStatusSetCustomMessageResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusSetCustomMessageResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusSetCustomMessageResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class UserStatusSetCustomMessageResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusSetCustomMessageResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusSetCustomMessageResponseApplicationJson>
      get serializer =>
...
abstract class UserStatusClearMessageResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusClearMessageResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusClearMessageResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class UserStatusClearMessageResponseApplicationJson
    implements
        ...
        Built<UserStatusClearMessageResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusClearMessageResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusClearMessageResponseApplicationJson>
      get serializer =>
...
abstract class UserStatusRevertStatusResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusRevertStatusResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusRevertStatusResponseApplicationJson_Ocs>
      get serializer =>
          _$userStatusRevertStatusResponseApplicationJsonOcsSerializer;

  @BuiltValueHook(finalizeBuilder: true)
  static void _validate(
    UserStatusRevertStatusResponseApplicationJson_OcsBuilder b,
  ) {
...
abstract class UserStatusRevertStatusResponseApplicationJson
    implements
        ...
        Built<UserStatusRevertStatusResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserStatusRevertStatusResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserStatusRevertStatusResponseApplicationJson>
      get serializer =>
...
abstract class Capabilities_UserStatus
    implements
        $Capabilities_UserStatusInterface,
        Built<Capabilities_UserStatus, Capabilities_UserStatusBuilder> {
  /// Creates a new Capabilities_UserStatus object using the builder pattern.
  factory Capabilities_UserStatus([
    void Function(Capabilities_UserStatusBuilder)? b,
  ...
  static Serializer<Capabilities_UserStatus> get serializer =>
      _$capabilitiesUserStatusSerializer;
}
...
extension $ClearAt_TimeExtension on ClearAt_Time {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<ClearAt_Time> get serializer =>
      $557344b3ba734aacc7109e5420fcb6c5Extension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static ClearAt_Time fromJson(Object? json) =>
      $557344b3ba734aacc7109e5420fcb6c5Extension._fromJson(json);
}
...
extension $UserStatusRevertStatusResponseApplicationJson_Ocs_DataExtension
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<UserStatusRevertStatusResponseApplicationJson_Ocs_Data>
      get serializer => $d77829de8b7590d2e16cdb714800f5beExtension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static UserStatusRevertStatusResponseApplicationJson_Ocs_Data fromJson(
    Object? json,
  ) =>
      $d77829de8b7590d2e16cdb714800f5beExtension._fromJson(json);
}

typedef _$557344b3ba734aacc7109e5420fcb6c5 = ({
  ClearAtTimeType? clearAtTimeType,
  int? $int
});

/// @nodoc
extension $557344b3ba734aacc7109e5420fcb6c5Extension
    on _$557344b3ba734aacc7109e5420fcb6c5 {
...
class _$557344b3ba734aacc7109e5420fcb6c5Serializer
    implements PrimitiveSerializer<_$557344b3ba734aacc7109e5420fcb6c5> {
  const _$557344b3ba734aacc7109e5420fcb6c5Serializer();
...
typedef _$d77829de8b7590d2e16cdb714800f5be = ({
  BuiltList<Never>? builtListNever,
  Private? private
});

/// @nodoc
extension $d77829de8b7590d2e16cdb714800f5beExtension
    on _$d77829de8b7590d2e16cdb714800f5be {
...
class _$d77829de8b7590d2e16cdb714800f5beSerializer
    implements PrimitiveSerializer<_$d77829de8b7590d2e16cdb714800f5be> {
  const _$d77829de8b7590d2e16cdb714800f5beSerializer();
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(Public)]),
        ListBuilder<Public>.new,
      )
      ..addBuilderFactory(
      ...
      ..add(
        UserStatusSetPredefinedMessageResponseApplicationJson_Ocs.serializer,
      )
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
        const FullType(Capabilities_UserStatus),
        Capabilities_UserStatusBuilder.new,
      )
