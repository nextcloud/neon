...
class $WeatherStatusClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<WeatherStatusSetModeResponseApplicationJson, void>
      $setMode_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $setMode_Request({
    ...
    final $mode =
        _$jsonSerializers.serialize(mode, specifiedType: const FullType(int));
    _parameters['mode'] = $mode;

    final _path =
        _i4.UriTemplate('/ocs/v2.php/apps/weather_status/api/v1/mode{?mode*}')
            .expand(_parameters);
...
// coverage:ignore-end
  ...
  Future<
          _i1
          .DynamiteResponse<WeatherStatusSetModeResponseApplicationJson, void>>
      setMode({
    required int mode,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            WeatherStatusSetModeResponseApplicationJson, void>(_serializer)
        .convert(_response);
  ...
  _i1.DynamiteSerializer<
          WeatherStatusUsePersonalAddressResponseApplicationJson, void>
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<
          WeatherStatusUsePersonalAddressResponseApplicationJson,
          void>> usePersonalAddress({bool? oCSAPIRequest}) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<WeatherStatusGetLocationResponseApplicationJson, void>
      $getLocation_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<WeatherStatusGetLocationResponseApplicationJson,
          void>> getLocation({bool? oCSAPIRequest}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            WeatherStatusGetLocationResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<WeatherStatusSetLocationResponseApplicationJson, void>
      $setLocation_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $setLocation_Request({
    ...
    final _parameters = <String, Object?>{};
    final $address = _$jsonSerializers.serialize(
      address,
    ...
    final $lat =
        _$jsonSerializers.serialize(lat, specifiedType: const FullType(double));
    _parameters['lat'] = $lat;

    final $lon =
        _$jsonSerializers.serialize(lon, specifiedType: const FullType(double));
    _parameters['lon'] = $lon;

    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/weather_status/api/v1/location{?address*,lat*,lon*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('put', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<WeatherStatusSetLocationResponseApplicationJson,
          void>> setLocation({
    String? address,
    double? lat,
    double? lon,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            WeatherStatusSetLocationResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<WeatherStatusGetForecastResponseApplicationJson, void>
      $getForecast_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<WeatherStatusGetForecastResponseApplicationJson,
          void>> getForecast({bool? oCSAPIRequest}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            WeatherStatusGetForecastResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<WeatherStatusGetFavoritesResponseApplicationJson, void>
      $getFavorites_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<WeatherStatusGetFavoritesResponseApplicationJson,
          void>> getFavorites({bool? oCSAPIRequest}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            WeatherStatusGetFavoritesResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<WeatherStatusSetFavoritesResponseApplicationJson, void>
      $setFavorites_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(
  ...
  _i3.Request $setFavorites_Request({
    ...
    final _parameters = <String, Object?>{};
    final $favorites = _$jsonSerializers.serialize(
      favorites,
    ...
    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/weather_status/api/v1/favorites{?favorites%5B%5D*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('put', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<WeatherStatusSetFavoritesResponseApplicationJson,
          void>> setFavorites({
    required BuiltList<String> favorites,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            WeatherStatusSetFavoritesResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
abstract class Success
    implements $SuccessInterface, Built<Success, SuccessBuilder> {
...
abstract class WeatherStatusSetModeResponseApplicationJson_Ocs
    implements
        ...
        Built<WeatherStatusSetModeResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusSetModeResponseApplicationJson_Ocs.fromJson(
  ...
  static Serializer<WeatherStatusSetModeResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class WeatherStatusSetModeResponseApplicationJson
    implements
        ...
        Built<WeatherStatusSetModeResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusSetModeResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusSetModeResponseApplicationJson>
      get serializer => _$weatherStatusSetModeResponseApplicationJsonSerializer;
}
...
abstract class Location
    implements $LocationInterface, Built<Location, LocationBuilder> {
...
@BuiltValue(instantiable: false)
abstract interface class $LocationWithSuccessInterface
    implements $LocationInterface, $SuccessInterface {}

abstract class LocationWithSuccess
    implements
        $LocationWithSuccessInterface,
        Built<LocationWithSuccess, LocationWithSuccessBuilder> {
  /// Creates a new LocationWithSuccess object using the builder pattern.
  factory LocationWithSuccess([void Function(LocationWithSuccessBuilder)? b]) =
  ...
  static Serializer<LocationWithSuccess> get serializer =>
...
abstract class WeatherStatusUsePersonalAddressResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusUsePersonalAddressResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusUsePersonalAddressResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class WeatherStatusUsePersonalAddressResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusUsePersonalAddressResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusUsePersonalAddressResponseApplicationJson>
      get serializer =>
...
@BuiltValue(instantiable: false)
abstract interface class $LocationWithModeInterface
    implements $LocationInterface, $ModeInterface {}

abstract class LocationWithMode
    implements
        $LocationWithModeInterface,
        Built<LocationWithMode, LocationWithModeBuilder> {
  /// Creates a new LocationWithMode object using the builder pattern.
  factory LocationWithMode([void Function(LocationWithModeBuilder)? b]) =
      _$LocationWithMode;
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory LocationWithMode.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<LocationWithMode> get serializer =>
...
abstract class WeatherStatusGetLocationResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusGetLocationResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusGetLocationResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class WeatherStatusGetLocationResponseApplicationJson
    implements
        ...
        Built<WeatherStatusGetLocationResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusGetLocationResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusGetLocationResponseApplicationJson>
      get serializer =>
...
abstract class WeatherStatusSetLocationResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusSetLocationResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusSetLocationResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class WeatherStatusSetLocationResponseApplicationJson
    implements
        ...
        Built<WeatherStatusSetLocationResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusSetLocationResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusSetLocationResponseApplicationJson>
      get serializer =>
...
abstract class Forecast_Data_Instant_Details
    implements
        ...
        Built<Forecast_Data_Instant_Details,
            Forecast_Data_Instant_DetailsBuilder> {
  /// Creates a new Forecast_Data_Instant_Details object using the builder pattern.
  factory Forecast_Data_Instant_Details([
    void Function(Forecast_Data_Instant_DetailsBuilder)? b,
  ...
  static Serializer<Forecast_Data_Instant_Details> get serializer =>
...
abstract class Forecast_Data_Instant
    implements
        $Forecast_Data_InstantInterface,
        Built<Forecast_Data_Instant, Forecast_Data_InstantBuilder> {
  /// Creates a new Forecast_Data_Instant object using the builder pattern.
  factory Forecast_Data_Instant([
    void Function(Forecast_Data_InstantBuilder)? b,
  ...
  static Serializer<Forecast_Data_Instant> get serializer =>
      _$forecastDataInstantSerializer;
}
...
abstract class Forecast_Data_Next12Hours_Summary
    implements
        ...
        Built<Forecast_Data_Next12Hours_Summary,
            Forecast_Data_Next12Hours_SummaryBuilder> {
  /// Creates a new Forecast_Data_Next12Hours_Summary object using the builder pattern.
  factory Forecast_Data_Next12Hours_Summary([
    void Function(Forecast_Data_Next12Hours_SummaryBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Forecast_Data_Next12Hours_Summary.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Forecast_Data_Next12Hours_Details
    implements
        ...
        Built<Forecast_Data_Next12Hours_Details,
            Forecast_Data_Next12Hours_DetailsBuilder> {
  /// Creates a new Forecast_Data_Next12Hours_Details object using the builder pattern.
  factory Forecast_Data_Next12Hours_Details([
    void Function(Forecast_Data_Next12Hours_DetailsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Forecast_Data_Next12Hours_Details.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Forecast_Data_Next12Hours
    implements
        $Forecast_Data_Next12HoursInterface,
        Built<Forecast_Data_Next12Hours, Forecast_Data_Next12HoursBuilder> {
  /// Creates a new Forecast_Data_Next12Hours object using the builder pattern.
  factory Forecast_Data_Next12Hours([
    void Function(Forecast_Data_Next12HoursBuilder)? b,
  ...
  static Serializer<Forecast_Data_Next12Hours> get serializer =>
      _$forecastDataNext12HoursSerializer;
}
...
abstract class Forecast_Data_Next1Hours_Summary
    implements
        ...
        Built<Forecast_Data_Next1Hours_Summary,
            Forecast_Data_Next1Hours_SummaryBuilder> {
  /// Creates a new Forecast_Data_Next1Hours_Summary object using the builder pattern.
  factory Forecast_Data_Next1Hours_Summary([
    void Function(Forecast_Data_Next1Hours_SummaryBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Forecast_Data_Next1Hours_Summary.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Forecast_Data_Next1Hours_Details
    implements
        ...
        Built<Forecast_Data_Next1Hours_Details,
            Forecast_Data_Next1Hours_DetailsBuilder> {
  /// Creates a new Forecast_Data_Next1Hours_Details object using the builder pattern.
  factory Forecast_Data_Next1Hours_Details([
    void Function(Forecast_Data_Next1Hours_DetailsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Forecast_Data_Next1Hours_Details.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Forecast_Data_Next1Hours
    implements
        $Forecast_Data_Next1HoursInterface,
        Built<Forecast_Data_Next1Hours, Forecast_Data_Next1HoursBuilder> {
  /// Creates a new Forecast_Data_Next1Hours object using the builder pattern.
  factory Forecast_Data_Next1Hours([
    void Function(Forecast_Data_Next1HoursBuilder)? b,
  ...
  static Serializer<Forecast_Data_Next1Hours> get serializer =>
      _$forecastDataNext1HoursSerializer;
}
...
abstract class Forecast_Data_Next6Hours_Summary
    implements
        ...
        Built<Forecast_Data_Next6Hours_Summary,
            Forecast_Data_Next6Hours_SummaryBuilder> {
  /// Creates a new Forecast_Data_Next6Hours_Summary object using the builder pattern.
  factory Forecast_Data_Next6Hours_Summary([
    void Function(Forecast_Data_Next6Hours_SummaryBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Forecast_Data_Next6Hours_Summary.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Forecast_Data_Next6Hours_Details
    implements
        ...
        Built<Forecast_Data_Next6Hours_Details,
            Forecast_Data_Next6Hours_DetailsBuilder> {
  /// Creates a new Forecast_Data_Next6Hours_Details object using the builder pattern.
  factory Forecast_Data_Next6Hours_Details([
    void Function(Forecast_Data_Next6Hours_DetailsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Forecast_Data_Next6Hours_Details.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Forecast_Data_Next6Hours
    implements
        $Forecast_Data_Next6HoursInterface,
        Built<Forecast_Data_Next6Hours, Forecast_Data_Next6HoursBuilder> {
  /// Creates a new Forecast_Data_Next6Hours object using the builder pattern.
  factory Forecast_Data_Next6Hours([
    void Function(Forecast_Data_Next6HoursBuilder)? b,
  ...
  static Serializer<Forecast_Data_Next6Hours> get serializer =>
      _$forecastDataNext6HoursSerializer;
}
...
abstract class Forecast_Data
    implements
        $Forecast_DataInterface,
        Built<Forecast_Data, Forecast_DataBuilder> {
  /// Creates a new Forecast_Data object using the builder pattern.
  factory Forecast_Data([void Function(Forecast_DataBuilder)? b]) =
      _$Forecast_Data;
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Forecast_Data.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Forecast
    implements $ForecastInterface, Built<Forecast, ForecastBuilder> {
...
abstract class WeatherStatusGetForecastResponseApplicationJson_Ocs_Data1
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusGetForecastResponseApplicationJson_Ocs_Data1.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusGetForecastResponseApplicationJson_Ocs_Data1>
      get serializer =>
...
abstract class WeatherStatusGetForecastResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusGetForecastResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusGetForecastResponseApplicationJson_Ocs>
      get serializer =>
          _$weatherStatusGetForecastResponseApplicationJsonOcsSerializer;

  @BuiltValueHook(finalizeBuilder: true)
  static void _validate(
    WeatherStatusGetForecastResponseApplicationJson_OcsBuilder b,
  ) {
...
abstract class WeatherStatusGetForecastResponseApplicationJson
    implements
        ...
        Built<WeatherStatusGetForecastResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusGetForecastResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusGetForecastResponseApplicationJson>
      get serializer =>
...
abstract class WeatherStatusGetFavoritesResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusGetFavoritesResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusGetFavoritesResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class WeatherStatusGetFavoritesResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusGetFavoritesResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusGetFavoritesResponseApplicationJson>
      get serializer =>
...
abstract class WeatherStatusSetFavoritesResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusSetFavoritesResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusSetFavoritesResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class WeatherStatusSetFavoritesResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory WeatherStatusSetFavoritesResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<WeatherStatusSetFavoritesResponseApplicationJson>
      get serializer =>
...
abstract class Capabilities_WeatherStatus
  ...
  factory Capabilities_WeatherStatus([
    void Function(Capabilities_WeatherStatusBuilder)? b,
  ...
  static Serializer<Capabilities_WeatherStatus> get serializer =>
      _$capabilitiesWeatherStatusSerializer;
}
...
extension $WeatherStatusGetForecastResponseApplicationJson_Ocs_DataExtension
  ...
  static Serializer<WeatherStatusGetForecastResponseApplicationJson_Ocs_Data>
      get serializer => $20fe3de793aed6fbf929c9b82b472b1aExtension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static WeatherStatusGetForecastResponseApplicationJson_Ocs_Data fromJson(
    Object? json,
  ) =>
...
/// @nodoc
extension $20fe3de793aed6fbf929c9b82b472b1aExtension
    on _$20fe3de793aed6fbf929c9b82b472b1a {
...
class _$20fe3de793aed6fbf929c9b82b472b1aSerializer
    implements PrimitiveSerializer<_$20fe3de793aed6fbf929c9b82b472b1a> {
  const _$20fe3de793aed6fbf929c9b82b472b1aSerializer();
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..add(
        WeatherStatusUsePersonalAddressResponseApplicationJson_Ocs.serializer,
      )
      ..addBuilderFactory(
        const FullType(LocationWithSuccess),
        LocationWithSuccessBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(LocationWithMode),
        LocationWithModeBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(Forecast_Data),
        Forecast_DataBuilder.new,
      )
      ..add(Forecast_Data.serializer)
      ..addBuilderFactory(
        const FullType(Forecast_Data_Instant),
        Forecast_Data_InstantBuilder.new,
      )
      ..add(Forecast_Data_Instant.serializer)
      ..addBuilderFactory(
        const FullType(Forecast_Data_Instant_Details),
        Forecast_Data_Instant_DetailsBuilder.new,
      )
      ..add(Forecast_Data_Instant_Details.serializer)
      ..addBuilderFactory(
        const FullType(Forecast_Data_Next12Hours),
        Forecast_Data_Next12HoursBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(Forecast_Data_Next1Hours),
        Forecast_Data_Next1HoursBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(Forecast_Data_Next6Hours),
        Forecast_Data_Next6HoursBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(Forecast)]),
        ListBuilder<Forecast>.new,
      )
      ..addBuilderFactory(
        const FullType(
          WeatherStatusGetForecastResponseApplicationJson_Ocs_Data1,
      ...
      ..add(
        WeatherStatusGetForecastResponseApplicationJson_Ocs_Data1.serializer,
      )
      ...
      ..addBuilderFactory(
        const FullType(Capabilities_WeatherStatus),
        Capabilities_WeatherStatusBuilder.new,
      )
