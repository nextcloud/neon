...
class $ApiClient {
  ...
  _i1.DynamiteSerializer<ApiGetUserMountsResponseApplicationJson, void>
      $getUserMounts_Serializer() => _i1.DynamiteSerializer(
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ApiGetUserMountsResponseApplicationJson, void>>
      getUserMounts({bool? oCSAPIRequest}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            ApiGetUserMountsResponseApplicationJson, void>(_serializer)
        .convert(_response);
...
class Mount_Type extends EnumClass {
  ...
  static Serializer<Mount_Type> get serializer =>
...
class Mount_Scope extends EnumClass {
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<Mount_Scope> get serializer =>
...
class StorageConfig_Type extends EnumClass {
  ...
  /// Returns the enum value associated to the [name].
  static StorageConfig_Type valueOf(String name) =>
      _$valueOfStorageConfig_Type(name);
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<StorageConfig_Type> get serializer =>
      const _$StorageConfig_TypeSerializer();
}

class _$StorageConfig_TypeSerializer
    implements PrimitiveSerializer<StorageConfig_Type> {
  const _$StorageConfig_TypeSerializer();

  static const Map<StorageConfig_Type, Object> _toWire =
      <StorageConfig_Type, Object>{
    StorageConfig_Type.personal: 'personal',
    StorageConfig_Type.system: 'system',
  };

  static const Map<Object, StorageConfig_Type> _fromWire =
      <Object, StorageConfig_Type>{
...
abstract class StorageConfig
    implements
        ...
        Built<StorageConfig, StorageConfigBuilder> {
  /// Creates a new StorageConfig object using the builder pattern.
  factory StorageConfig([void Function(StorageConfigBuilder)? b]) =
      _$StorageConfig;
...
abstract class ApiGetUserMountsResponseApplicationJson_Ocs
    implements
        ...
        Built<ApiGetUserMountsResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGetUserMountsResponseApplicationJson_Ocs.fromJson(
  ...
  static Serializer<ApiGetUserMountsResponseApplicationJson_Ocs>
      get serializer => _$apiGetUserMountsResponseApplicationJsonOcsSerializer;
}
...
abstract class ApiGetUserMountsResponseApplicationJson
    implements
        ...
        Built<ApiGetUserMountsResponseApplicationJson,
  ...
  factory ApiGetUserMountsResponseApplicationJson([
    void Function(ApiGetUserMountsResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGetUserMountsResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(Mount)]),
        ListBuilder<Mount>.new,
      ))
    .build();
