...
abstract class Capabilities0_FilesSharing_Sharebymail_UploadFilesDrop
  ...
  // coverage:ignore-start
  factory Capabilities0_FilesSharing_Sharebymail_UploadFilesDrop.fromJson(
  ...
  static Serializer<Capabilities0_FilesSharing_Sharebymail_UploadFilesDrop>
      get serializer =>
...
abstract class Capabilities0_FilesSharing_Sharebymail_Password
    implements
        ...
        Built<Capabilities0_FilesSharing_Sharebymail_Password,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Capabilities0_FilesSharing_Sharebymail_Password.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<Capabilities0_FilesSharing_Sharebymail_Password>
      get serializer =>
...
abstract class Capabilities0_FilesSharing_Sharebymail_ExpireDate
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Capabilities0_FilesSharing_Sharebymail_ExpireDate.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<Capabilities0_FilesSharing_Sharebymail_ExpireDate>
      get serializer =>
...
abstract class Capabilities0_FilesSharing_Sharebymail
    implements
        ...
        Built<Capabilities0_FilesSharing_Sharebymail,
  ...
  factory Capabilities0_FilesSharing_Sharebymail([
    void Function(Capabilities0_FilesSharing_SharebymailBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Capabilities0_FilesSharing_Sharebymail.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Capabilities0_FilesSharing
  ...
  factory Capabilities0_FilesSharing([
    void Function(Capabilities0_FilesSharingBuilder)? b,
  ...
  static Serializer<Capabilities0_FilesSharing> get serializer =>
      _$capabilities0FilesSharingSerializer;
}
...
abstract class Capabilities0
    implements
        $Capabilities0Interface,
        Built<Capabilities0, Capabilities0Builder> {
  /// Creates a new Capabilities0 object using the builder pattern.
  factory Capabilities0([void Function(Capabilities0Builder)? b]) =
      _$Capabilities0;
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Capabilities0.fromJson(Map<String, dynamic> json) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
extension $CapabilitiesExtension on Capabilities {
  ...
  static Serializer<Capabilities> get serializer =>
      $7f1b9936cf688676379074249fff891bExtension._serializer;

  /// Creates a new object from the given [json] data.
  ///
  /// Use `toJson` to serialize it back into json.
  static Capabilities fromJson(Object? json) =>
      $7f1b9936cf688676379074249fff891bExtension._fromJson(json);
}

typedef _$7f1b9936cf688676379074249fff891b = ({
  BuiltList<Never>? builtListNever,
  Capabilities0? capabilities0
});

/// @nodoc
extension $7f1b9936cf688676379074249fff891bExtension
    on _$7f1b9936cf688676379074249fff891b {
...
class _$7f1b9936cf688676379074249fff891bSerializer
    implements PrimitiveSerializer<_$7f1b9936cf688676379074249fff891b> {
  const _$7f1b9936cf688676379074249fff891bSerializer();
...
final Serializers _$serializers = (Serializers().toBuilder()
      ..addBuilderFactory(
        const FullType(Capabilities0),
        Capabilities0Builder.new,
      )
      ..add(Capabilities0.serializer)
      ..addBuilderFactory(
        const FullType(Capabilities0_FilesSharing),
        Capabilities0_FilesSharingBuilder.new,
      )
...
final Serializers _$jsonSerializers = (_$serializers.toBuilder()
      ...
      ..addPlugin(
        _i4.StandardJsonPlugin(
          typesToLeaveAsList: const {_$7f1b9936cf688676379074249fff891b},
        ),
      )
