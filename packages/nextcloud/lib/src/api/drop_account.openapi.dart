...
abstract class Capabilities_DropAccount_Delay
    implements
        ...
        Built<Capabilities_DropAccount_Delay,
            Capabilities_DropAccount_DelayBuilder> {
  /// Creates a new Capabilities_DropAccount_Delay object using the builder pattern.
  factory Capabilities_DropAccount_Delay([
    void Function(Capabilities_DropAccount_DelayBuilder)? b,
  ...
  static Serializer<Capabilities_DropAccount_Delay> get serializer =>
...
abstract class Capabilities_DropAccount
    implements
        $Capabilities_DropAccountInterface,
        Built<Capabilities_DropAccount, Capabilities_DropAccountBuilder> {
  /// Creates a new Capabilities_DropAccount object using the builder pattern.
  factory Capabilities_DropAccount([
    void Function(Capabilities_DropAccountBuilder)? b,
  ...
  static Serializer<Capabilities_DropAccount> get serializer =>
      _$capabilitiesDropAccountSerializer;
}
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..addBuilderFactory(
        const FullType(Capabilities_DropAccount),
        Capabilities_DropAccountBuilder.new,
      )
      ..add(Capabilities_DropAccount.serializer)
      ..addBuilderFactory(
        const FullType(Capabilities_DropAccount_Delay),
        Capabilities_DropAccount_DelayBuilder.new,
      )
