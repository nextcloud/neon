...
const ThemingGetThemeStylesheetPlain _$themingGetThemeStylesheetPlain$0 =
    ThemingGetThemeStylesheetPlain._('\$0');
const ThemingGetThemeStylesheetPlain _$themingGetThemeStylesheetPlain$1 =
    ThemingGetThemeStylesheetPlain._('\$1');

ThemingGetThemeStylesheetPlain _$valueOfThemingGetThemeStylesheetPlain(
    String name) {
  switch (name) {
    case '\$0':
...
final BuiltSet<ThemingGetThemeStylesheetPlain>
    _$themingGetThemeStylesheetPlainValues = BuiltSet<
        ThemingGetThemeStylesheetPlain>(const <ThemingGetThemeStylesheetPlain>[
...
ThemingGetThemeStylesheetWithCustomCss
    _$valueOfThemingGetThemeStylesheetWithCustomCss(String name) {
  switch (name) {
    case '\$0':
...
final BuiltSet<ThemingGetThemeStylesheetWithCustomCss>
    _$themingGetThemeStylesheetWithCustomCssValues = BuiltSet<
        ThemingGetThemeStylesheetWithCustomCss>(const <ThemingGetThemeStylesheetWithCustomCss>[
  _$themingGetThemeStylesheetWithCustomCss$0,
  _$themingGetThemeStylesheetWithCustomCss$1,
]);

const ThemingGetImageUseSvg _$themingGetImageUseSvg$0 =
    ThemingGetImageUseSvg._('\$0');
const ThemingGetImageUseSvg _$themingGetImageUseSvg$1 =
    ThemingGetImageUseSvg._('\$1');
...
Serializer<UserThemeDisableThemeResponseApplicationJson>
...
Serializer<PublicCapabilities_Theming> _$publicCapabilitiesThemingSerializer =
    _$PublicCapabilities_ThemingSerializer();
Serializer<PublicCapabilities> _$publicCapabilitiesSerializer =
    _$PublicCapabilitiesSerializer();

class _$ThemingGetManifestResponseApplicationJson_IconsSerializer
    implements
        StructuredSerializer<ThemingGetManifestResponseApplicationJson_Icons> {
  @override
  ...
  Iterable<Object?> serialize(Serializers serializers,
      ThemingGetManifestResponseApplicationJson_Icons object,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'type':
          ...
          break;
        case 'sizes':
          result.sizes = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
      }
    }
...
class _$ThemingGetManifestResponseApplicationJsonSerializer
  ...
  Iterable<Object?> serialize(
      Serializers serializers, ThemingGetManifestResponseApplicationJson object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'name',
      ...
      serializers.serialize(object.shortName,
          specifiedType: const FullType(String)),
      'start_url',
      serializers.serialize(object.startUrl,
          specifiedType: const FullType(String)),
      'theme_color',
      serializers.serialize(object.themeColor,
          specifiedType: const FullType(String)),
      'background_color',
      ...
      serializers.serialize(object.icons,
          specifiedType: const FullType(BuiltList,
              [FullType(ThemingGetManifestResponseApplicationJson_Icons)])),
      'display',
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'short_name':
          ...
          break;
        case 'start_url':
          result.startUrl = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
        case 'theme_color':
...
class _$UserThemeEnableThemeResponseApplicationJson_OcsSerializer
    implements
        StructuredSerializer<UserThemeEnableThemeResponseApplicationJson_Ocs> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  Iterable<Object?> serialize(Serializers serializers,
      UserThemeEnableThemeResponseApplicationJson_Ocs object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'meta',
...
class _$UserThemeEnableThemeResponseApplicationJsonSerializer
    implements
        StructuredSerializer<UserThemeEnableThemeResponseApplicationJson> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  Iterable<Object?> serialize(Serializers serializers,
      UserThemeEnableThemeResponseApplicationJson object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'ocs',
...
class _$UserThemeDisableThemeResponseApplicationJson_OcsSerializer
    implements
        StructuredSerializer<UserThemeDisableThemeResponseApplicationJson_Ocs> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  Iterable<Object?> serialize(Serializers serializers,
      UserThemeDisableThemeResponseApplicationJson_Ocs object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'meta',
      serializers.serialize(object.meta,
...
class _$UserThemeDisableThemeResponseApplicationJsonSerializer
    implements
        StructuredSerializer<UserThemeDisableThemeResponseApplicationJson> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  Iterable<Object?> serialize(Serializers serializers,
      UserThemeDisableThemeResponseApplicationJson object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'ocs',
      serializers.serialize(object.ocs,
...
class _$PublicCapabilities_ThemingSerializer
    implements StructuredSerializer<PublicCapabilities_Theming> {
  @override
  final Iterable<Type> types = const [
    PublicCapabilities_Theming,
  ...
  @override
  Iterable<Object?> serialize(
      Serializers serializers, PublicCapabilities_Theming object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'name',
      serializers.serialize(object.name, specifiedType: const FullType(String)),
      ...
      serializers.serialize(object.color,
          specifiedType: const FullType(String)),
      'color-text',
      serializers.serialize(object.colorText,
          specifiedType: const FullType(String)),
      'color-element',
      serializers.serialize(object.colorElement,
          specifiedType: const FullType(String)),
      'color-element-bright',
      serializers.serialize(object.colorElementBright,
          specifiedType: const FullType(String)),
      'color-element-dark',
      serializers.serialize(object.colorElementDark,
          specifiedType: const FullType(String)),
      'logo',
      ...
      serializers.serialize(object.background,
          specifiedType: const FullType(String)),
      'background-plain',
      serializers.serialize(object.backgroundPlain,
          specifiedType: const FullType(bool)),
      'background-default',
      serializers.serialize(object.backgroundDefault,
          specifiedType: const FullType(bool)),
      'logoheader',
      serializers.serialize(object.logoheader,
          specifiedType: const FullType(String)),
      'favicon',
      serializers.serialize(object.favicon,
          specifiedType: const FullType(String)),
    ];
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'color':
          ...
          break;
        case 'color-text':
          result.colorText = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
        case 'color-element':
          result.colorElement = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
        case 'color-element-bright':
          result.colorElementBright = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
        case 'color-element-dark':
          result.colorElementDark = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
        case 'logo':
        ...
        case 'background-plain':
          result.backgroundPlain = serializers.deserialize(value,
              specifiedType: const FullType(bool))! as bool;
          break;
        case 'background-default':
          result.backgroundDefault = serializers.deserialize(value,
              specifiedType: const FullType(bool))! as bool;
          break;
        case 'logoheader':
          result.logoheader = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
        case 'favicon':
...
class _$PublicCapabilitiesSerializer
    implements StructuredSerializer<PublicCapabilities> {
  @override
  ...
  @override
  Iterable<Object?> serialize(
      Serializers serializers, PublicCapabilities object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'theming',
      serializers.serialize(object.theming,
          specifiedType: const FullType(PublicCapabilities_Theming)),
    ];
...
class _$ThemingGetManifestResponseApplicationJson_Icons
    extends ThemingGetManifestResponseApplicationJson_Icons {
  @override
  final String src;
  @override
  final String type;
  ...
  _$ThemingGetManifestResponseApplicationJson_Icons._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        src, r'ThemingGetManifestResponseApplicationJson_Icons', 'src');
    BuiltValueNullFieldError.checkNotNull(
        type, r'ThemingGetManifestResponseApplicationJson_Icons', 'type');
    BuiltValueNullFieldError.checkNotNull(
  ...
  ThemingGetManifestResponseApplicationJson_Icons rebuild(
          void Function(ThemingGetManifestResponseApplicationJson_IconsBuilder)
              updates) =>
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'ThemingGetManifestResponseApplicationJson_Icons')
          ..add('src', src)
          ..add('type', type)
          ..add('sizes', sizes))
        .toString();
...
class ThemingGetManifestResponseApplicationJson_IconsBuilder
  ...
  @override
  void replace(
      covariant ThemingGetManifestResponseApplicationJson_Icons other) {
    ...
    final _$result = _$v ??
        _$ThemingGetManifestResponseApplicationJson_Icons._(
            ...
            type: BuiltValueNullFieldError.checkNotNull(type,
                r'ThemingGetManifestResponseApplicationJson_Icons', 'type'),
            sizes: BuiltValueNullFieldError.checkNotNull(sizes,
                r'ThemingGetManifestResponseApplicationJson_Icons', 'sizes'));
    replace(_$result);
    return _$result;
  }
}
...
abstract mixin class $ThemingGetManifestResponseApplicationJsonInterfaceBuilder {
  ...
  void update(
      void Function($ThemingGetManifestResponseApplicationJsonInterfaceBuilder)
          updates);
  String? get name;
  ...
  set icons(
      ListBuilder<ThemingGetManifestResponseApplicationJson_Icons>? icons);

  String? get display;
  set display(String? display);
}

class _$ThemingGetManifestResponseApplicationJson
    extends ThemingGetManifestResponseApplicationJson {
  @override
  final String name;
  @override
  ...
  factory _$ThemingGetManifestResponseApplicationJson(
          [void Function(ThemingGetManifestResponseApplicationJsonBuilder)?
              updates]) =>
      (ThemingGetManifestResponseApplicationJsonBuilder()..update(updates))
          ._build();
  ...
  _$ThemingGetManifestResponseApplicationJson._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        name, r'ThemingGetManifestResponseApplicationJson', 'name');
    BuiltValueNullFieldError.checkNotNull(
    ...
    BuiltValueNullFieldError.checkNotNull(backgroundColor,
        r'ThemingGetManifestResponseApplicationJson', 'backgroundColor');
    BuiltValueNullFieldError.checkNotNull(description,
        r'ThemingGetManifestResponseApplicationJson', 'description');
    BuiltValueNullFieldError.checkNotNull(
        icons, r'ThemingGetManifestResponseApplicationJson', 'icons');
    BuiltValueNullFieldError.checkNotNull(
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'ThemingGetManifestResponseApplicationJson')
          ..add('name', name)
...
class ThemingGetManifestResponseApplicationJsonBuilder
    implements
        Builder<ThemingGetManifestResponseApplicationJson,
  ...
  set themeColor(covariant String? themeColor) =>
      _$this._themeColor = themeColor;
  ...
  ListBuilder<ThemingGetManifestResponseApplicationJson_Icons> get icons =>
      _$this._icons ??=
          ListBuilder<ThemingGetManifestResponseApplicationJson_Icons>();
  set icons(
    ...
    try {
      _$result = _$v ??
          _$ThemingGetManifestResponseApplicationJson._(
              ...
              icons: icons.build(),
              display: BuiltValueNullFieldError.checkNotNull(display, r'ThemingGetManifestResponseApplicationJson', 'display'));
    } catch (_) {
...
class _$UserThemeEnableThemeResponseApplicationJson_Ocs
    extends UserThemeEnableThemeResponseApplicationJson_Ocs {
  @override
  final OCSMeta meta;
  @override
  ...
  _$UserThemeEnableThemeResponseApplicationJson_Ocs._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        meta, r'UserThemeEnableThemeResponseApplicationJson_Ocs', 'meta');
    BuiltValueNullFieldError.checkNotNull(
  ...
  UserThemeEnableThemeResponseApplicationJson_Ocs rebuild(
          void Function(UserThemeEnableThemeResponseApplicationJson_OcsBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UserThemeEnableThemeResponseApplicationJson_Ocs &&
        meta == other.meta &&
        data == other.data;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'UserThemeEnableThemeResponseApplicationJson_Ocs')
          ..add('meta', meta)
          ..add('data', data))
        .toString();
  }
...
class UserThemeEnableThemeResponseApplicationJson_OcsBuilder
  ...
  @override
  void replace(
      covariant UserThemeEnableThemeResponseApplicationJson_Ocs other) {
    ArgumentError.checkNotNull(other, 'other');
      ...
      _$result = _$v ??
          _$UserThemeEnableThemeResponseApplicationJson_Ocs._(
              ...
              data: BuiltValueNullFieldError.checkNotNull(data,
                  r'UserThemeEnableThemeResponseApplicationJson_Ocs', 'data'));
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'meta';
...
class _$UserThemeEnableThemeResponseApplicationJson
    extends UserThemeEnableThemeResponseApplicationJson {
  @override
  final UserThemeEnableThemeResponseApplicationJson_Ocs ocs;

  factory _$UserThemeEnableThemeResponseApplicationJson(
          [void Function(UserThemeEnableThemeResponseApplicationJsonBuilder)?
              updates]) =>
      (UserThemeEnableThemeResponseApplicationJsonBuilder()..update(updates))
          ._build();

  _$UserThemeEnableThemeResponseApplicationJson._({required this.ocs})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        ocs, r'UserThemeEnableThemeResponseApplicationJson', 'ocs');
  }
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UserThemeEnableThemeResponseApplicationJson &&
        ocs == other.ocs;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'UserThemeEnableThemeResponseApplicationJson')
          ..add('ocs', ocs))
        .toString();
  }
}
...
class UserThemeEnableThemeResponseApplicationJsonBuilder
    implements
        Builder<UserThemeEnableThemeResponseApplicationJson,
  ...
  set ocs(
          covariant UserThemeEnableThemeResponseApplicationJson_OcsBuilder?
              ocs) =>
      _$this._ocs = ocs;
  ...
  _$UserThemeEnableThemeResponseApplicationJson _build() {
    ...
    try {
      _$result = _$v ??
          _$UserThemeEnableThemeResponseApplicationJson._(ocs: ocs.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'ocs';
...
abstract mixin class $UserThemeDisableThemeResponseApplicationJson_OcsInterfaceBuilder {
  void replace(
      $UserThemeDisableThemeResponseApplicationJson_OcsInterface other);
  void update(
      void Function(
...
class _$UserThemeDisableThemeResponseApplicationJson_Ocs
    extends UserThemeDisableThemeResponseApplicationJson_Ocs {
  @override
  final OCSMeta meta;
  @override
  final JsonObject data;
  ...
  _$UserThemeDisableThemeResponseApplicationJson_Ocs._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        meta, r'UserThemeDisableThemeResponseApplicationJson_Ocs', 'meta');
    BuiltValueNullFieldError.checkNotNull(
  ...
  UserThemeDisableThemeResponseApplicationJson_Ocs rebuild(
          void Function(UserThemeDisableThemeResponseApplicationJson_OcsBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UserThemeDisableThemeResponseApplicationJson_Ocs &&
        meta == other.meta &&
        data == other.data;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'UserThemeDisableThemeResponseApplicationJson_Ocs')
          ..add('meta', meta)
          ..add('data', data))
        .toString();
  }
...
class UserThemeDisableThemeResponseApplicationJson_OcsBuilder
  ...
  @override
  void replace(
      covariant UserThemeDisableThemeResponseApplicationJson_Ocs other) {
    ArgumentError.checkNotNull(other, 'other');
    ...
    try {
      _$result = _$v ??
          _$UserThemeDisableThemeResponseApplicationJson_Ocs._(
              meta: meta.build(),
              data: BuiltValueNullFieldError.checkNotNull(data,
                  r'UserThemeDisableThemeResponseApplicationJson_Ocs', 'data'));
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'meta';
...
class _$UserThemeDisableThemeResponseApplicationJson
    extends UserThemeDisableThemeResponseApplicationJson {
  @override
  final UserThemeDisableThemeResponseApplicationJson_Ocs ocs;

  factory _$UserThemeDisableThemeResponseApplicationJson(
          [void Function(UserThemeDisableThemeResponseApplicationJsonBuilder)?
              updates]) =>
      (UserThemeDisableThemeResponseApplicationJsonBuilder()..update(updates))
          ._build();

  _$UserThemeDisableThemeResponseApplicationJson._({required this.ocs})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        ocs, r'UserThemeDisableThemeResponseApplicationJson', 'ocs');
  }
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UserThemeDisableThemeResponseApplicationJson &&
        ocs == other.ocs;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'UserThemeDisableThemeResponseApplicationJson')
          ..add('ocs', ocs))
        .toString();
  }
}
...
class UserThemeDisableThemeResponseApplicationJsonBuilder
    implements
        Builder<UserThemeDisableThemeResponseApplicationJson,
  ...
  set ocs(
          covariant UserThemeDisableThemeResponseApplicationJson_OcsBuilder?
              ocs) =>
      _$this._ocs = ocs;
  ...
  _$UserThemeDisableThemeResponseApplicationJson _build() {
    ...
    try {
      _$result = _$v ??
          _$UserThemeDisableThemeResponseApplicationJson._(ocs: ocs.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'ocs';
...
abstract mixin class $PublicCapabilities_ThemingInterfaceBuilder {
  ...
  void update(
      void Function($PublicCapabilities_ThemingInterfaceBuilder) updates);
  String? get name;
  set name(String? name);
...
class _$PublicCapabilities_Theming extends PublicCapabilities_Theming {
  ...
  factory _$PublicCapabilities_Theming(
          [void Function(PublicCapabilities_ThemingBuilder)? updates]) =>
  ...
  _$PublicCapabilities_Theming._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        name, r'PublicCapabilities_Theming', 'name');
    BuiltValueNullFieldError.checkNotNull(
        url, r'PublicCapabilities_Theming', 'url');
    BuiltValueNullFieldError.checkNotNull(
        slogan, r'PublicCapabilities_Theming', 'slogan');
    BuiltValueNullFieldError.checkNotNull(
        color, r'PublicCapabilities_Theming', 'color');
    BuiltValueNullFieldError.checkNotNull(
        colorText, r'PublicCapabilities_Theming', 'colorText');
    BuiltValueNullFieldError.checkNotNull(
        colorElement, r'PublicCapabilities_Theming', 'colorElement');
    BuiltValueNullFieldError.checkNotNull(colorElementBright,
        r'PublicCapabilities_Theming', 'colorElementBright');
    BuiltValueNullFieldError.checkNotNull(
        colorElementDark, r'PublicCapabilities_Theming', 'colorElementDark');
    BuiltValueNullFieldError.checkNotNull(
        logo, r'PublicCapabilities_Theming', 'logo');
    BuiltValueNullFieldError.checkNotNull(
        background, r'PublicCapabilities_Theming', 'background');
    BuiltValueNullFieldError.checkNotNull(
    ...
    BuiltValueNullFieldError.checkNotNull(
        logoheader, r'PublicCapabilities_Theming', 'logoheader');
    BuiltValueNullFieldError.checkNotNull(
        favicon, r'PublicCapabilities_Theming', 'favicon');
  }

  @override
  PublicCapabilities_Theming rebuild(
          void Function(PublicCapabilities_ThemingBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PublicCapabilities_ThemingBuilder toBuilder() =>
      PublicCapabilities_ThemingBuilder()..replace(this);
...
class PublicCapabilities_ThemingBuilder
  ...
  set colorElement(covariant String? colorElement) =>
      _$this._colorElement = colorElement;

  String? _colorElementBright;
  String? get colorElementBright => _$this._colorElementBright;
  set colorElementBright(covariant String? colorElementBright) =>
      _$this._colorElementBright = colorElementBright;

  String? _colorElementDark;
  String? get colorElementDark => _$this._colorElementDark;
  set colorElementDark(covariant String? colorElementDark) =>
      _$this._colorElementDark = colorElementDark;
  ...
  set background(covariant String? background) =>
      _$this._background = background;

  bool? _backgroundPlain;
  bool? get backgroundPlain => _$this._backgroundPlain;
  set backgroundPlain(covariant bool? backgroundPlain) =>
      _$this._backgroundPlain = backgroundPlain;

  bool? _backgroundDefault;
  bool? get backgroundDefault => _$this._backgroundDefault;
  set backgroundDefault(covariant bool? backgroundDefault) =>
      _$this._backgroundDefault = backgroundDefault;

  String? _logoheader;
  String? get logoheader => _$this._logoheader;
  set logoheader(covariant String? logoheader) =>
      _$this._logoheader = logoheader;
  ...
  _$PublicCapabilities_Theming _build() {
    final _$result = _$v ??
        _$PublicCapabilities_Theming._(
            ...
            backgroundPlain: BuiltValueNullFieldError.checkNotNull(backgroundPlain, r'PublicCapabilities_Theming', 'backgroundPlain'),
            backgroundDefault: BuiltValueNullFieldError.checkNotNull(backgroundDefault, r'PublicCapabilities_Theming', 'backgroundDefault'),
...
class _$PublicCapabilities extends PublicCapabilities {
  ...
  factory _$PublicCapabilities(
          [void Function(PublicCapabilitiesBuilder)? updates]) =>
      (PublicCapabilitiesBuilder()..update(updates))._build();

  _$PublicCapabilities._({required this.theming}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        theming, r'PublicCapabilities', 'theming');
  }

  @override
  PublicCapabilities rebuild(
          void Function(PublicCapabilitiesBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PublicCapabilitiesBuilder toBuilder() =>
      PublicCapabilitiesBuilder()..replace(this);
...
class PublicCapabilitiesBuilder
    implements
        Builder<PublicCapabilities, PublicCapabilitiesBuilder>,
        $PublicCapabilitiesInterfaceBuilder {
  _$PublicCapabilities? _$v;

  PublicCapabilities_ThemingBuilder? _theming;
  PublicCapabilities_ThemingBuilder get theming =>
      _$this._theming ??= PublicCapabilities_ThemingBuilder();
  set theming(covariant PublicCapabilities_ThemingBuilder? theming) =>
  ...
  _$PublicCapabilities _build() {
    ...
    try {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'PublicCapabilities', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
