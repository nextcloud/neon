...
class $Client extends _i1.DynamiteClient {
  ...
  late final $OpenLocalEditorClient openLocalEditor =
      $OpenLocalEditorClient(this);

  late final $TemplateClient template = $TemplateClient(this);

  late final $TransferOwnershipClient transferOwnership =
      $TransferOwnershipClient(this);
}
...
class $ApiClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Uint8List, void> $getThumbnail_Serializer() =>
  ...
  _i3.Request $getThumbnail_Request({
    ...
    final $x =
        _$jsonSerializers.serialize(x, specifiedType: const FullType(int));
    _parameters['x'] = $x;

    final $y =
        _$jsonSerializers.serialize(y, specifiedType: const FullType(int));
    _parameters['y'] = $y;

    final $file = _$jsonSerializers.serialize(
      file,
    ...
    final _path =
        _i5.UriTemplate('/index.php/apps/files/api/v1/thumbnail/{x}/{y}/{file}')
            .expand(_parameters);
...
class $DirectEditingClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<DirectEditingInfoResponseApplicationJson, void>
      $info_Serializer() => _i1.DynamiteSerializer(
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<DirectEditingInfoResponseApplicationJson, void>>
      info({bool? oCSAPIRequest}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            DirectEditingInfoResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<DirectEditingTemplatesResponseApplicationJson, void>
      $templates_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $templates_Request({
    ...
    final _parameters = <String, Object?>{};
    final $editorId = _$jsonSerializers.serialize(
      editorId,
      specifiedType: const FullType(String),
    );
    _parameters['editorId'] = $editorId;

    final $creatorId = _$jsonSerializers.serialize(
      creatorId,
      specifiedType: const FullType(String),
    );
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<DirectEditingTemplatesResponseApplicationJson,
          void>> templates({
    required String editorId,
    required String creatorId,
    bool? oCSAPIRequest,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            DirectEditingTemplatesResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<DirectEditingOpenResponseApplicationJson, void>
      $open_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $open_Request({
    ...
    final _path = _i5.UriTemplate(
      '/ocs/v2.php/apps/files/api/v1/directEditing/open{?path*,editorId*,fileId*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<DirectEditingOpenResponseApplicationJson, void>>
      open({
    required String path,
    String? editorId,
    int? fileId,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            DirectEditingOpenResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<DirectEditingCreateResponseApplicationJson, void>
      $create_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $create_Request({
    ...
    final $templateId = _$jsonSerializers.serialize(
      templateId,
      specifiedType: const FullType(String),
    );
    ...
    final _path = _i5.UriTemplate(
      '/ocs/v2.php/apps/files/api/v1/directEditing/create{?path*,editorId*,creatorId*,templateId*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<DirectEditingCreateResponseApplicationJson, void>>
      create({
    required String path,
    required String editorId,
    required String creatorId,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            DirectEditingCreateResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
class $OpenLocalEditorClient {
  ...
  /// Builds a serializer to parse the response of [$create_Request].
  @_i2.experimental
  _i1.DynamiteSerializer<OpenLocalEditorCreateResponseApplicationJson, void>
      $create_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $create_Request({
    ...
    final _path =
        _i5.UriTemplate('/ocs/v2.php/apps/files/api/v1/openlocaleditor{?path*}')
            .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
          _i1
          .DynamiteResponse<OpenLocalEditorCreateResponseApplicationJson, void>>
      create({
    required String path,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _serializer = $create_Serializer();
    final _rawResponse = await _i1.ResponseConverter<
            OpenLocalEditorCreateResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<OpenLocalEditorValidateResponseApplicationJson, void>
      $validate_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $validate_Request({
    ...
    final _path = _i5.UriTemplate(
      '/ocs/v2.php/apps/files/api/v1/openlocaleditor/{token}{?path*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<OpenLocalEditorValidateResponseApplicationJson,
          void>> validate({
    required String path,
    required String token,
    bool? oCSAPIRequest,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            OpenLocalEditorValidateResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
class $TemplateClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<TemplateListResponseApplicationJson, void>
      $list_Serializer() => _i1.DynamiteSerializer(
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<TemplateListResponseApplicationJson, void>> list({
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse =
        await _i1.ResponseConverter<TemplateListResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  /// Builds a serializer to parse the response of [$create_Request].
  @_i2.experimental
  _i1.DynamiteSerializer<TemplateCreateResponseApplicationJson, void>
      $create_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $create_Request({
    ...
    final _parameters = <String, Object?>{};
    final $filePath = _$jsonSerializers.serialize(
      filePath,
      specifiedType: const FullType(String),
    );
    _parameters['filePath'] = $filePath;

    var $templatePath = _$jsonSerializers.serialize(
      templatePath,
      specifiedType: const FullType(String),
    );
    $templatePath ??= '';
    ...
    var $templateType = _$jsonSerializers.serialize(
      templateType,
      specifiedType: const FullType(String),
    );
    $templateType ??= 'user';
    ...
    final _path = _i5.UriTemplate(
      '/ocs/v2.php/apps/files/api/v1/templates/create{?filePath*,templatePath*,templateType*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  ///  * [$create_Request] for the request send by this method.
  ///  * [$create_Serializer] for a converter to parse the `Response` from an executed request.
  Future<_i1.DynamiteResponse<TemplateCreateResponseApplicationJson, void>>
      create({
    required String filePath,
    String? templatePath,
    String? templateType,
    ...
    final _serializer = $create_Serializer();
    final _rawResponse = await _i1.ResponseConverter<
            TemplateCreateResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<TemplatePathResponseApplicationJson, void>
      $path_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $path_Request({
    ...
    final _path = _i5.UriTemplate(
      '/ocs/v2.php/apps/files/api/v1/templates/path{?templatePath*,copySystemTemplates*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<TemplatePathResponseApplicationJson, void>> path({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<TemplatePathResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
...
class $TransferOwnershipClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<TransferOwnershipTransferResponseApplicationJson, void>
      $transfer_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $transfer_Request({
    ...
    final _parameters = <String, Object?>{};
    final $recipient = _$jsonSerializers.serialize(
      recipient,
      specifiedType: const FullType(String),
    );
    ...
    final _path = _i5.UriTemplate(
      '/ocs/v2.php/apps/files/api/v1/transferownership{?recipient*,path*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<TransferOwnershipTransferResponseApplicationJson,
          void>> transfer({
    required String recipient,
    required String path,
    bool? oCSAPIRequest,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            TransferOwnershipTransferResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<TransferOwnershipAcceptResponseApplicationJson, void>
      $accept_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $accept_Request({
    ...
    final _path =
        _i5.UriTemplate('/ocs/v2.php/apps/files/api/v1/transferownership/{id}')
            .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<TransferOwnershipAcceptResponseApplicationJson,
          void>> accept({
    required int id,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            TransferOwnershipAcceptResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<TransferOwnershipRejectResponseApplicationJson, void>
      $reject_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<TransferOwnershipRejectResponseApplicationJson,
          void>> reject({
    required int id,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            TransferOwnershipRejectResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
abstract class DirectEditingInfoResponseApplicationJson_Ocs_Data_Editors
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingInfoResponseApplicationJson_Ocs_Data_Editors.fromJson(
  ...
  static Serializer<DirectEditingInfoResponseApplicationJson_Ocs_Data_Editors>
      get serializer =>
...
abstract class DirectEditingInfoResponseApplicationJson_Ocs_Data_Creators
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingInfoResponseApplicationJson_Ocs_Data_Creators.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingInfoResponseApplicationJson_Ocs_Data_Creators>
      get serializer =>
...
abstract interface class $DirectEditingInfoResponseApplicationJson_Ocs_DataInterface {
  BuiltMap<String, DirectEditingInfoResponseApplicationJson_Ocs_Data_Editors>
      get editors;
  BuiltMap<String, DirectEditingInfoResponseApplicationJson_Ocs_Data_Creators>
      get creators;
}
...
abstract class DirectEditingInfoResponseApplicationJson_Ocs_Data
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingInfoResponseApplicationJson_Ocs_Data.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingInfoResponseApplicationJson_Ocs_Data>
      get serializer =>
...
abstract class DirectEditingInfoResponseApplicationJson_Ocs
    implements
        ...
        Built<DirectEditingInfoResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingInfoResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingInfoResponseApplicationJson_Ocs>
      get serializer => _$directEditingInfoResponseApplicationJsonOcsSerializer;
}
...
abstract class DirectEditingInfoResponseApplicationJson
    implements
        ...
        Built<DirectEditingInfoResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingInfoResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class DirectEditingTemplatesResponseApplicationJson_Ocs_Data_Templates
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingTemplatesResponseApplicationJson_Ocs_Data_Templates.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class DirectEditingTemplatesResponseApplicationJson_Ocs_Data
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingTemplatesResponseApplicationJson_Ocs_Data.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingTemplatesResponseApplicationJson_Ocs_Data>
      get serializer =>
...
abstract class DirectEditingTemplatesResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingTemplatesResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingTemplatesResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class DirectEditingTemplatesResponseApplicationJson
    implements
        ...
        Built<DirectEditingTemplatesResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingTemplatesResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingTemplatesResponseApplicationJson>
      get serializer =>
...
abstract class DirectEditingOpenResponseApplicationJson_Ocs_Data
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingOpenResponseApplicationJson_Ocs_Data.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingOpenResponseApplicationJson_Ocs_Data>
      get serializer =>
...
abstract class DirectEditingOpenResponseApplicationJson_Ocs
    implements
        ...
        Built<DirectEditingOpenResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingOpenResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingOpenResponseApplicationJson_Ocs>
      get serializer => _$directEditingOpenResponseApplicationJsonOcsSerializer;
}
...
abstract class DirectEditingOpenResponseApplicationJson
    implements
        ...
        Built<DirectEditingOpenResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingOpenResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class DirectEditingCreateResponseApplicationJson_Ocs_Data
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingCreateResponseApplicationJson_Ocs_Data.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingCreateResponseApplicationJson_Ocs_Data>
      get serializer =>
...
abstract class DirectEditingCreateResponseApplicationJson_Ocs
    implements
        ...
        Built<DirectEditingCreateResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingCreateResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingCreateResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class DirectEditingCreateResponseApplicationJson
    implements
        ...
        Built<DirectEditingCreateResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory DirectEditingCreateResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<DirectEditingCreateResponseApplicationJson>
      get serializer => _$directEditingCreateResponseApplicationJsonSerializer;
}
...
abstract class OpenLocalEditorCreateResponseApplicationJson_Ocs_Data
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OpenLocalEditorCreateResponseApplicationJson_Ocs_Data.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OpenLocalEditorCreateResponseApplicationJson_Ocs_Data>
      get serializer =>
...
abstract class OpenLocalEditorCreateResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OpenLocalEditorCreateResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OpenLocalEditorCreateResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class OpenLocalEditorCreateResponseApplicationJson
    implements
        ...
        Built<OpenLocalEditorCreateResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OpenLocalEditorCreateResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OpenLocalEditorCreateResponseApplicationJson>
      get serializer =>
...
abstract class OpenLocalEditorValidateResponseApplicationJson_Ocs_Data
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OpenLocalEditorValidateResponseApplicationJson_Ocs_Data.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OpenLocalEditorValidateResponseApplicationJson_Ocs_Data>
      get serializer =>
...
abstract class OpenLocalEditorValidateResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OpenLocalEditorValidateResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OpenLocalEditorValidateResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class OpenLocalEditorValidateResponseApplicationJson
    implements
        ...
        Built<OpenLocalEditorValidateResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory OpenLocalEditorValidateResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<OpenLocalEditorValidateResponseApplicationJson>
      get serializer =>
...
abstract class TemplateFileCreator
    implements
        ...
        Built<TemplateFileCreator, TemplateFileCreatorBuilder> {
  /// Creates a new TemplateFileCreator object using the builder pattern.
  factory TemplateFileCreator([void Function(TemplateFileCreatorBuilder)? b]) =
  ...
  static Serializer<TemplateFileCreator> get serializer =>
...
abstract class TemplateListResponseApplicationJson_Ocs
    implements
        ...
        Built<TemplateListResponseApplicationJson_Ocs,
  ...
  factory TemplateListResponseApplicationJson_Ocs([
    void Function(TemplateListResponseApplicationJson_OcsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TemplateListResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class TemplateListResponseApplicationJson
    implements
        ...
        Built<TemplateListResponseApplicationJson,
  ...
  factory TemplateListResponseApplicationJson([
    void Function(TemplateListResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TemplateListResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class TemplateFile
    implements
        $TemplateFileInterface,
        Built<TemplateFile, TemplateFileBuilder> {
  /// Creates a new TemplateFile object using the builder pattern.
  factory TemplateFile([void Function(TemplateFileBuilder)? b]) =
      _$TemplateFile;
...
abstract class TemplateCreateResponseApplicationJson_Ocs
    implements
        ...
        Built<TemplateCreateResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TemplateCreateResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class TemplateCreateResponseApplicationJson
    implements
        ...
        Built<TemplateCreateResponseApplicationJson,
  ...
  factory TemplateCreateResponseApplicationJson([
    void Function(TemplateCreateResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TemplateCreateResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
class TemplatePathCopySystemTemplates extends EnumClass {
  ...
  static const TemplatePathCopySystemTemplates $0 =
      _$templatePathCopySystemTemplates$0;

  /// `1`
  @BuiltValueEnumConst(wireName: '1')
  static const TemplatePathCopySystemTemplates $1 =
      _$templatePathCopySystemTemplates$1;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<TemplatePathCopySystemTemplates> get values =>
      _$templatePathCopySystemTemplatesValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static TemplatePathCopySystemTemplates valueOf(String name) =>
      _$valueOfTemplatePathCopySystemTemplates(name);
...
class _$TemplatePathCopySystemTemplatesSerializer
    implements PrimitiveSerializer<TemplatePathCopySystemTemplates> {
  const _$TemplatePathCopySystemTemplatesSerializer();

  static const Map<TemplatePathCopySystemTemplates, Object> _toWire =
      <TemplatePathCopySystemTemplates, Object>{
    TemplatePathCopySystemTemplates.$0: 0,
    TemplatePathCopySystemTemplates.$1: 1,
  };

  static const Map<Object, TemplatePathCopySystemTemplates> _fromWire =
      <Object, TemplatePathCopySystemTemplates>{
...
abstract class TemplatePathResponseApplicationJson_Ocs_Data
    implements
        ...
        Built<TemplatePathResponseApplicationJson_Ocs_Data,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TemplatePathResponseApplicationJson_Ocs_Data.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<TemplatePathResponseApplicationJson_Ocs_Data>
      get serializer => _$templatePathResponseApplicationJsonOcsDataSerializer;
}
...
abstract class TemplatePathResponseApplicationJson_Ocs
    implements
        ...
        Built<TemplatePathResponseApplicationJson_Ocs,
  ...
  factory TemplatePathResponseApplicationJson_Ocs([
    void Function(TemplatePathResponseApplicationJson_OcsBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TemplatePathResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class TemplatePathResponseApplicationJson
    implements
        ...
        Built<TemplatePathResponseApplicationJson,
  ...
  factory TemplatePathResponseApplicationJson([
    void Function(TemplatePathResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TemplatePathResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class TransferOwnershipTransferResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TransferOwnershipTransferResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<TransferOwnershipTransferResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class TransferOwnershipTransferResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TransferOwnershipTransferResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<TransferOwnershipTransferResponseApplicationJson>
      get serializer =>
...
abstract class TransferOwnershipAcceptResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TransferOwnershipAcceptResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<TransferOwnershipAcceptResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class TransferOwnershipAcceptResponseApplicationJson
    implements
        ...
        Built<TransferOwnershipAcceptResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TransferOwnershipAcceptResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<TransferOwnershipAcceptResponseApplicationJson>
      get serializer =>
...
abstract class TransferOwnershipRejectResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TransferOwnershipRejectResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<TransferOwnershipRejectResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class TransferOwnershipRejectResponseApplicationJson
    implements
        ...
        Built<TransferOwnershipRejectResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory TransferOwnershipRejectResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<TransferOwnershipRejectResponseApplicationJson>
      get serializer =>
...
abstract class Capabilities_Files_DirectEditing
    implements
        ...
        Built<Capabilities_Files_DirectEditing,
            Capabilities_Files_DirectEditingBuilder> {
  /// Creates a new Capabilities_Files_DirectEditing object using the builder pattern.
  factory Capabilities_Files_DirectEditing([
    void Function(Capabilities_Files_DirectEditingBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory Capabilities_Files_DirectEditing.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Capabilities_Files
    implements
        $Capabilities_FilesInterface,
        Built<Capabilities_Files, Capabilities_FilesBuilder> {
  /// Creates a new Capabilities_Files object using the builder pattern.
  factory Capabilities_Files([void Function(Capabilities_FilesBuilder)? b]) =
      _$Capabilities_Files;
  ...
  static Serializer<Capabilities_Files> get serializer =>
      _$capabilitiesFilesSerializer;
}
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..add(
        DirectEditingInfoResponseApplicationJson_Ocs_Data_Editors.serializer,
      )
      ..addBuilderFactory(
      ...
      ..add(
        DirectEditingInfoResponseApplicationJson_Ocs_Data_Creators.serializer,
      )
      ..addBuilderFactory(
        const FullType(BuiltMap, [
          FullType(String),
      ...
      ..addBuilderFactory(
        const FullType(TemplateFileCreator),
        TemplateFileCreatorBuilder.new,
      )
      ...
      ..addBuilderFactory(
        const FullType(Capabilities_Files),
        Capabilities_FilesBuilder.new,
      )
