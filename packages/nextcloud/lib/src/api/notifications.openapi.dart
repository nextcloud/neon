...
class $ApiClient {
  ...
  _i1.DynamiteSerializer<ApiGenerateNotificationResponseApplicationJson, void>
      $generateNotification_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $generateNotification_Request({
    ...
    final $shortMessage = _$jsonSerializers.serialize(
      shortMessage,
    ...
    var $longMessage = _$jsonSerializers.serialize(
      longMessage,
      specifiedType: const FullType(String),
    );
    $longMessage ??= '';
...
// coverage:ignore-end
    ...
    _request.headers['OCS-APIRequest'] =
        const _i5.HeaderEncoder().convert($oCSAPIRequest);
  ...
  Future<
      _i1.DynamiteResponse<ApiGenerateNotificationResponseApplicationJson,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            ApiGenerateNotificationResponseApplicationJson, void>(_serializer)
        .convert(_response);
...
class $EndpointClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<EndpointListNotificationsResponseApplicationJson,
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<EndpointListNotificationsResponseApplicationJson,
          EndpointEndpointListNotificationsHeaders>> listNotifications({
    EndpointListNotificationsApiVersion? apiVersion,
    bool? oCSAPIRequest,
  }) async {
  ...
  _i1.DynamiteSerializer<
          EndpointDeleteAllNotificationsResponseApplicationJson, void>
...
// coverage:ignore-end
  ...
  _i1.DynamiteSerializer<EndpointGetNotificationResponseApplicationJson, void>
      $getNotification_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<EndpointGetNotificationResponseApplicationJson,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            EndpointGetNotificationResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<
          EndpointDeleteNotificationResponseApplicationJson, void>
      $deleteNotification_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<EndpointDeleteNotificationResponseApplicationJson,
  ...
  _i1.DynamiteSerializer<EndpointConfirmIdsForUserResponseApplicationJson, void>
      $confirmIdsForUser_Serializer() => _i1.DynamiteSerializer(
            bodyType: const FullType(
  ...
  _i3.Request $confirmIdsForUser_Request({
    ...
    final _parameters = <String, Object?>{};
    final $ids = _$jsonSerializers.serialize(
      ids,
    ...
    final _path = _i4.UriTemplate(
      '/ocs/v2.php/apps/notifications/api/{apiVersion}/notifications/exists{?ids%5B%5D*}',
    ).expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('post', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<
      _i1.DynamiteResponse<EndpointConfirmIdsForUserResponseApplicationJson,
          void>> confirmIdsForUser({
    required BuiltList<int> ids,
    EndpointConfirmIdsForUserApiVersion? apiVersion,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            EndpointConfirmIdsForUserResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
class $PushClient {
  ...
  _i1.DynamiteSerializer<PushRegisterDeviceResponseApplicationJson, void>
      $registerDevice_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $registerDevice_Request({
    ...
    final _parameters = <String, Object?>{};
    final $pushTokenHash = _$jsonSerializers.serialize(
      pushTokenHash,
      specifiedType: const FullType(String),
    );
    _parameters['pushTokenHash'] = $pushTokenHash;

    final $devicePublicKey = _$jsonSerializers.serialize(
      devicePublicKey,
      specifiedType: const FullType(String),
    );
    _parameters['devicePublicKey'] = $devicePublicKey;

    final $proxyServer = _$jsonSerializers.serialize(
      proxyServer,
      specifiedType: const FullType(String),
    );
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<PushRegisterDeviceResponseApplicationJson, void>>
      registerDevice({
    required String pushTokenHash,
    required String devicePublicKey,
    required String proxyServer,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            PushRegisterDeviceResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  _i1.DynamiteSerializer<PushRemoveDeviceResponseApplicationJson, void>
      $removeDevice_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $removeDevice_Request({
    ...
    final _path =
        _i4.UriTemplate('/ocs/v2.php/apps/notifications/api/{apiVersion}/push')
            .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('delete', _uri);
    _request.headers['Accept'] = 'application/json';
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<PushRemoveDeviceResponseApplicationJson, void>>
      removeDevice({
    PushRemoveDeviceApiVersion? apiVersion,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            PushRemoveDeviceResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
class $SettingsClient {
  ...
  _i1.DynamiteSerializer<SettingsPersonalResponseApplicationJson, void>
      $personal_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $personal_Request({
    ...
    final _parameters = <String, Object?>{};
    final $batchSetting = _$jsonSerializers.serialize(
      batchSetting,
      specifiedType: const FullType(int),
    );
    _parameters['batchSetting'] = $batchSetting;

    final $soundNotification = _$jsonSerializers.serialize(
      soundNotification,
      specifiedType: const FullType(String),
    );
    _parameters['soundNotification'] = $soundNotification;

    final $soundTalk = _$jsonSerializers.serialize(
      soundTalk,
      specifiedType: const FullType(String),
    );
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<SettingsPersonalResponseApplicationJson, void>>
      personal({
    required int batchSetting,
    required String soundNotification,
    required String soundTalk,
    ...
    final _rawResponse = await _i1.ResponseConverter<
            SettingsPersonalResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  _i1.DynamiteSerializer<SettingsAdminResponseApplicationJson, void>
      $admin_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $admin_Request({
    ...
    var $apiVersion = _$jsonSerializers.serialize(
      apiVersion,
      specifiedType: const FullType(SettingsAdminApiVersion),
    );
    $apiVersion ??= 'v2';
    _parameters['apiVersion'] = $apiVersion;
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<SettingsAdminResponseApplicationJson, void>>
      admin({
    required int batchSetting,
    required String soundNotification,
    required String soundTalk,
    ...
    final _rawResponse =
        await _i1.ResponseConverter<SettingsAdminResponseApplicationJson, void>(
      _serializer,
    ).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
...
class ApiGenerateNotificationApiVersion extends EnumClass {
  ...
  /// `v1`
  static const ApiGenerateNotificationApiVersion v1 =
      _$apiGenerateNotificationApiVersionV1;

  /// `v2`
  static const ApiGenerateNotificationApiVersion v2 =
      _$apiGenerateNotificationApiVersionV2;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<ApiGenerateNotificationApiVersion> get values =>
      _$apiGenerateNotificationApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static ApiGenerateNotificationApiVersion valueOf(String name) =>
...
class _$ApiGenerateNotificationApiVersionSerializer
    implements PrimitiveSerializer<ApiGenerateNotificationApiVersion> {
  const _$ApiGenerateNotificationApiVersionSerializer();

  static const Map<ApiGenerateNotificationApiVersion, Object> _toWire =
      <ApiGenerateNotificationApiVersion, Object>{
    ApiGenerateNotificationApiVersion.v1: 'v1',
    ApiGenerateNotificationApiVersion.v2: 'v2',
  };

  static const Map<Object, ApiGenerateNotificationApiVersion> _fromWire =
      <Object, ApiGenerateNotificationApiVersion>{
...
abstract class ApiGenerateNotificationResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGenerateNotificationResponseApplicationJson_Ocs.fromJson(
  ...
  static Serializer<ApiGenerateNotificationResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class ApiGenerateNotificationResponseApplicationJson
    implements
        ...
        Built<ApiGenerateNotificationResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ApiGenerateNotificationResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<ApiGenerateNotificationResponseApplicationJson>
      get serializer =>
...
class EndpointListNotificationsApiVersion extends EnumClass {
  ...
  /// `v1`
  static const EndpointListNotificationsApiVersion v1 =
      _$endpointListNotificationsApiVersionV1;

  /// `v2`
  static const EndpointListNotificationsApiVersion v2 =
      _$endpointListNotificationsApiVersionV2;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<EndpointListNotificationsApiVersion> get values =>
      _$endpointListNotificationsApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static EndpointListNotificationsApiVersion valueOf(String name) =>
...
class _$EndpointListNotificationsApiVersionSerializer
  ...
  static const Map<EndpointListNotificationsApiVersion, Object> _toWire =
...
abstract class NotificationAction
    implements
        ...
        Built<NotificationAction, NotificationActionBuilder> {
  /// Creates a new NotificationAction object using the builder pattern.
  factory NotificationAction([void Function(NotificationActionBuilder)? b]) =
...
abstract class Notification
    implements
        ...
        Built<Notification, NotificationBuilder> {
  /// Creates a new Notification object using the builder pattern.
  factory Notification([void Function(NotificationBuilder)? b]) =
      _$Notification;
...
abstract class EndpointListNotificationsResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointListNotificationsResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointListNotificationsResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class EndpointListNotificationsResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointListNotificationsResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointListNotificationsResponseApplicationJson>
      get serializer =>
...
abstract class EndpointEndpointListNotificationsHeaders
    implements
        ...
        Built<EndpointEndpointListNotificationsHeaders,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointEndpointListNotificationsHeaders.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
class EndpointDeleteAllNotificationsApiVersion extends EnumClass {
  ...
  /// `v1`
  static const EndpointDeleteAllNotificationsApiVersion v1 =
      _$endpointDeleteAllNotificationsApiVersionV1;

  /// `v2`
  static const EndpointDeleteAllNotificationsApiVersion v2 =
...
abstract class EndpointDeleteAllNotificationsResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointDeleteAllNotificationsResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointDeleteAllNotificationsResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class EndpointDeleteAllNotificationsResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointDeleteAllNotificationsResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointDeleteAllNotificationsResponseApplicationJson>
      get serializer =>
...
class EndpointGetNotificationApiVersion extends EnumClass {
  ...
  /// `v1`
  static const EndpointGetNotificationApiVersion v1 =
      _$endpointGetNotificationApiVersionV1;

  /// `v2`
  static const EndpointGetNotificationApiVersion v2 =
      _$endpointGetNotificationApiVersionV2;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<EndpointGetNotificationApiVersion> get values =>
      _$endpointGetNotificationApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static EndpointGetNotificationApiVersion valueOf(String name) =>
...
class _$EndpointGetNotificationApiVersionSerializer
    implements PrimitiveSerializer<EndpointGetNotificationApiVersion> {
  const _$EndpointGetNotificationApiVersionSerializer();

  static const Map<EndpointGetNotificationApiVersion, Object> _toWire =
      <EndpointGetNotificationApiVersion, Object>{
    EndpointGetNotificationApiVersion.v1: 'v1',
    EndpointGetNotificationApiVersion.v2: 'v2',
  };

  static const Map<Object, EndpointGetNotificationApiVersion> _fromWire =
      <Object, EndpointGetNotificationApiVersion>{
...
abstract class EndpointGetNotificationResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointGetNotificationResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointGetNotificationResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class EndpointGetNotificationResponseApplicationJson
    implements
        ...
        Built<EndpointGetNotificationResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointGetNotificationResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointGetNotificationResponseApplicationJson>
      get serializer =>
...
class EndpointDeleteNotificationApiVersion extends EnumClass {
  ...
  /// `v1`
  static const EndpointDeleteNotificationApiVersion v1 =
      _$endpointDeleteNotificationApiVersionV1;

  /// `v2`
  static const EndpointDeleteNotificationApiVersion v2 =
      _$endpointDeleteNotificationApiVersionV2;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<EndpointDeleteNotificationApiVersion> get values =>
      _$endpointDeleteNotificationApiVersionValues;
  // coverage:ignore-end
...
abstract class EndpointDeleteNotificationResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointDeleteNotificationResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointDeleteNotificationResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class EndpointDeleteNotificationResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointDeleteNotificationResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointDeleteNotificationResponseApplicationJson>
      get serializer =>
...
class EndpointConfirmIdsForUserApiVersion extends EnumClass {
  ...
  /// `v1`
  static const EndpointConfirmIdsForUserApiVersion v1 =
      _$endpointConfirmIdsForUserApiVersionV1;

  /// `v2`
  static const EndpointConfirmIdsForUserApiVersion v2 =
      _$endpointConfirmIdsForUserApiVersionV2;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<EndpointConfirmIdsForUserApiVersion> get values =>
      _$endpointConfirmIdsForUserApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static EndpointConfirmIdsForUserApiVersion valueOf(String name) =>
...
class _$EndpointConfirmIdsForUserApiVersionSerializer
  ...
  static const Map<EndpointConfirmIdsForUserApiVersion, Object> _toWire =
...
abstract class EndpointConfirmIdsForUserResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointConfirmIdsForUserResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointConfirmIdsForUserResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class EndpointConfirmIdsForUserResponseApplicationJson
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory EndpointConfirmIdsForUserResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<EndpointConfirmIdsForUserResponseApplicationJson>
      get serializer =>
...
class PushRegisterDeviceApiVersion extends EnumClass {
  ...
  /// `v2`
  static const PushRegisterDeviceApiVersion v2 =
      _$pushRegisterDeviceApiVersionV2;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<PushRegisterDeviceApiVersion> get values =>
      _$pushRegisterDeviceApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static PushRegisterDeviceApiVersion valueOf(String name) =>
      _$valueOfPushRegisterDeviceApiVersion(name);
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<PushRegisterDeviceApiVersion> get serializer =>
      const _$PushRegisterDeviceApiVersionSerializer();
}

class _$PushRegisterDeviceApiVersionSerializer
    implements PrimitiveSerializer<PushRegisterDeviceApiVersion> {
  const _$PushRegisterDeviceApiVersionSerializer();

  static const Map<PushRegisterDeviceApiVersion, Object> _toWire =
      <PushRegisterDeviceApiVersion, Object>{
    PushRegisterDeviceApiVersion.v2: 'v2',
  };

  static const Map<Object, PushRegisterDeviceApiVersion> _fromWire =
      <Object, PushRegisterDeviceApiVersion>{
...
abstract class PushDevice
    implements $PushDeviceInterface, Built<PushDevice, PushDeviceBuilder> {
...
abstract class PushRegisterDeviceResponseApplicationJson_Ocs
    implements
        ...
        Built<PushRegisterDeviceResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory PushRegisterDeviceResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<PushRegisterDeviceResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class PushRegisterDeviceResponseApplicationJson
    implements
        ...
        Built<PushRegisterDeviceResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory PushRegisterDeviceResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
class PushRemoveDeviceApiVersion extends EnumClass {
  ...
  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<PushRemoveDeviceApiVersion> get values =>
      _$pushRemoveDeviceApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static PushRemoveDeviceApiVersion valueOf(String name) =>
      _$valueOfPushRemoveDeviceApiVersion(name);
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<PushRemoveDeviceApiVersion> get serializer =>
      const _$PushRemoveDeviceApiVersionSerializer();
}

class _$PushRemoveDeviceApiVersionSerializer
    implements PrimitiveSerializer<PushRemoveDeviceApiVersion> {
  const _$PushRemoveDeviceApiVersionSerializer();

  static const Map<PushRemoveDeviceApiVersion, Object> _toWire =
      <PushRemoveDeviceApiVersion, Object>{
    PushRemoveDeviceApiVersion.v2: 'v2',
  };

  static const Map<Object, PushRemoveDeviceApiVersion> _fromWire =
      <Object, PushRemoveDeviceApiVersion>{
...
abstract class PushRemoveDeviceResponseApplicationJson_Ocs
    implements
        ...
        Built<PushRemoveDeviceResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory PushRemoveDeviceResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<PushRemoveDeviceResponseApplicationJson_Ocs>
      get serializer => _$pushRemoveDeviceResponseApplicationJsonOcsSerializer;
}
...
abstract class PushRemoveDeviceResponseApplicationJson
    implements
        ...
        Built<PushRemoveDeviceResponseApplicationJson,
  ...
  factory PushRemoveDeviceResponseApplicationJson([
    void Function(PushRemoveDeviceResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory PushRemoveDeviceResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
class SettingsPersonalApiVersion extends EnumClass {
  ...
  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<SettingsPersonalApiVersion> get values =>
      _$settingsPersonalApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static SettingsPersonalApiVersion valueOf(String name) =>
      _$valueOfSettingsPersonalApiVersion(name);
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<SettingsPersonalApiVersion> get serializer =>
      const _$SettingsPersonalApiVersionSerializer();
}

class _$SettingsPersonalApiVersionSerializer
    implements PrimitiveSerializer<SettingsPersonalApiVersion> {
  const _$SettingsPersonalApiVersionSerializer();

  static const Map<SettingsPersonalApiVersion, Object> _toWire =
      <SettingsPersonalApiVersion, Object>{
    SettingsPersonalApiVersion.v2: 'v2',
  };

  static const Map<Object, SettingsPersonalApiVersion> _fromWire =
      <Object, SettingsPersonalApiVersion>{
...
abstract class SettingsPersonalResponseApplicationJson_Ocs
    implements
        ...
        Built<SettingsPersonalResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory SettingsPersonalResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<SettingsPersonalResponseApplicationJson_Ocs>
      get serializer => _$settingsPersonalResponseApplicationJsonOcsSerializer;
}
...
abstract class SettingsPersonalResponseApplicationJson
    implements
        ...
        Built<SettingsPersonalResponseApplicationJson,
  ...
  factory SettingsPersonalResponseApplicationJson([
    void Function(SettingsPersonalResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory SettingsPersonalResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
class SettingsAdminApiVersion extends EnumClass {
  ...
  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<SettingsAdminApiVersion> get values =>
      _$settingsAdminApiVersionValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static SettingsAdminApiVersion valueOf(String name) =>
      _$valueOfSettingsAdminApiVersion(name);
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<SettingsAdminApiVersion> get serializer =>
      const _$SettingsAdminApiVersionSerializer();
}

class _$SettingsAdminApiVersionSerializer
    implements PrimitiveSerializer<SettingsAdminApiVersion> {
  const _$SettingsAdminApiVersionSerializer();

  static const Map<SettingsAdminApiVersion, Object> _toWire =
      <SettingsAdminApiVersion, Object>{
    SettingsAdminApiVersion.v2: 'v2',
  };

  static const Map<Object, SettingsAdminApiVersion> _fromWire =
      <Object, SettingsAdminApiVersion>{
...
abstract class SettingsAdminResponseApplicationJson_Ocs
    implements
        ...
        Built<SettingsAdminResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory SettingsAdminResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class SettingsAdminResponseApplicationJson
    implements
        ...
        Built<SettingsAdminResponseApplicationJson,
  ...
  factory SettingsAdminResponseApplicationJson([
    void Function(SettingsAdminResponseApplicationJsonBuilder)? b,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory SettingsAdminResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class Capabilities_Notifications
  ...
  factory Capabilities_Notifications([
    void Function(Capabilities_NotificationsBuilder)? b,
  ...
  static Serializer<Capabilities_Notifications> get serializer =>
      _$capabilitiesNotificationsSerializer;
}
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..addBuilderFactory(
        const FullType(NotificationAction),
        NotificationActionBuilder.new,
      )
      ...
      ..add(
        EndpointDeleteAllNotificationsResponseApplicationJson_Ocs.serializer,
      )
      ...
      ..addBuilderFactory(
        const FullType(Capabilities_Notifications),
        Capabilities_NotificationsBuilder.new,
      )
