...
class $IconClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Uint8List, void> $getFavicon_Serializer() =>
  ...
  _i3.Request $getFavicon_Request({String? app}) {
    ...
    final _path = _i4.UriTemplate('/index.php/apps/theming/favicon/{app}')
        .expand(_parameters);
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<Uint8List, void>> getFavicon({
    String? app,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Uint8List, void> $getTouchIcon_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: const FullType(Uint8List),
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $getTouchIcon_Request({String? app}) {
    ...
    final _path = _i4.UriTemplate('/index.php/apps/theming/icon/{app}')
        .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('get', _uri);
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<Uint8List, void>> getTouchIcon({
    String? app,
  }) async {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Uint8List, void> $getThemedIcon_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: const FullType(Uint8List),
        headersType: null,
        serializers: _$jsonSerializers,
  ...
  _i3.Request $getThemedIcon_Request({
    ...
    final $image = _$jsonSerializers.serialize(
      image,
    ...
    final _path = _i4.UriTemplate('/index.php/apps/theming/img/{app}/{image}')
        .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('get', _uri);
...
class $ThemingClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<String, void> $getThemeStylesheet_Serializer() =>
      _i1.DynamiteSerializer(
  ...
  _i3.Request $getThemeStylesheet_Request({
    ...
    final _parameters = <String, Object?>{};
    final $themeId = _$jsonSerializers.serialize(
      themeId,
      specifiedType: const FullType(String),
    );
    _parameters['themeId'] = $themeId;

    var $plain = _$jsonSerializers.serialize(
      plain,
      specifiedType: const FullType(ThemingGetThemeStylesheetPlain),
    );
    $plain ??= 0;
...
// coverage:ignore-end
  ...
  _i3.Request $getImage_Request({
    ...
    var $useSvg = _$jsonSerializers.serialize(
      useSvg,
      specifiedType: const FullType(ThemingGetImageUseSvg),
    );
    $useSvg ??= 1;
    _parameters['useSvg'] = $useSvg;

    final _path =
        _i4.UriTemplate('/index.php/apps/theming/image/{key}{?useSvg*}')
            .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('get', _uri);
...
// coverage:ignore-end
  ...
  _i1.DynamiteSerializer<ThemingGetManifestResponseApplicationJson, void>
      $getManifest_Serializer() => _i1.DynamiteSerializer(
  ...
  _i3.Request $getManifest_Request({String? app}) {
    ...
    final _path = _i4.UriTemplate('/index.php/apps/theming/manifest/{app}')
        .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
    final _request = _i3.Request('get', _uri);
...
// coverage:ignore-end
  ...
  Future<_i1.DynamiteResponse<ThemingGetManifestResponseApplicationJson, void>>
      getManifest({String? app}) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            ThemingGetManifestResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
class $UserThemeClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<Uint8List, void> $getBackground_Serializer() =>
      _i1.DynamiteSerializer(
        bodyType: const FullType(Uint8List),
        headersType: null,
        serializers: _$jsonSerializers,
...
// coverage:ignore-end
  ...
  _i1.DynamiteSerializer<UserThemeEnableThemeResponseApplicationJson, void>
      $enableTheme_Serializer() => _i1.DynamiteSerializer(
            bodyType:
...
// coverage:ignore-end
  ...
  Future<
          _i1
          .DynamiteResponse<UserThemeEnableThemeResponseApplicationJson, void>>
      enableTheme({
    required String themeId,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            UserThemeEnableThemeResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  _i1.DynamiteSerializer<UserThemeDisableThemeResponseApplicationJson, void>
      $disableTheme_Serializer() => _i1.DynamiteSerializer(
            bodyType:
  ...
  _i3.Request $disableTheme_Request({
    ...
    final _path =
        _i4.UriTemplate('/ocs/v2.php/apps/theming/api/v1/theme/{themeId}')
            .expand(_parameters);
    final _uri = Uri.parse('${_rootClient.baseURL}$_path');
...
// coverage:ignore-end
  ...
  Future<
          _i1
          .DynamiteResponse<UserThemeDisableThemeResponseApplicationJson, void>>
      disableTheme({
    required String themeId,
    bool? oCSAPIRequest,
  }) async {
    ...
    final _rawResponse = await _i1.ResponseConverter<
            UserThemeDisableThemeResponseApplicationJson, void>(_serializer)
        .convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
}
...
class ThemingGetThemeStylesheetPlain extends EnumClass {
  ...
  static const ThemingGetThemeStylesheetPlain $0 =
      _$themingGetThemeStylesheetPlain$0;

  /// `1`
  @BuiltValueEnumConst(wireName: '1')
  static const ThemingGetThemeStylesheetPlain $1 =
      _$themingGetThemeStylesheetPlain$1;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<ThemingGetThemeStylesheetPlain> get values =>
      _$themingGetThemeStylesheetPlainValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static ThemingGetThemeStylesheetPlain valueOf(String name) =>
      _$valueOfThemingGetThemeStylesheetPlain(name);
...
class _$ThemingGetThemeStylesheetPlainSerializer
    implements PrimitiveSerializer<ThemingGetThemeStylesheetPlain> {
  const _$ThemingGetThemeStylesheetPlainSerializer();

  static const Map<ThemingGetThemeStylesheetPlain, Object> _toWire =
      <ThemingGetThemeStylesheetPlain, Object>{
    ThemingGetThemeStylesheetPlain.$0: 0,
    ThemingGetThemeStylesheetPlain.$1: 1,
  };

  static const Map<Object, ThemingGetThemeStylesheetPlain> _fromWire =
      <Object, ThemingGetThemeStylesheetPlain>{
...
class ThemingGetThemeStylesheetWithCustomCss extends EnumClass {
  ...
  /// `0`
  @BuiltValueEnumConst(wireName: '0')
  static const ThemingGetThemeStylesheetWithCustomCss $0 =
      _$themingGetThemeStylesheetWithCustomCss$0;

  /// `1`
  @BuiltValueEnumConst(wireName: '1')
  static const ThemingGetThemeStylesheetWithCustomCss $1 =
      _$themingGetThemeStylesheetWithCustomCss$1;

  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<ThemingGetThemeStylesheetWithCustomCss> get values =>
...
class ThemingGetImageUseSvg extends EnumClass {
  ...
  /// Returns a set with all values this enum contains.
  // coverage:ignore-start
  static BuiltSet<ThemingGetImageUseSvg> get values =>
      _$themingGetImageUseSvgValues;
  // coverage:ignore-end

  /// Returns the enum value associated to the [name].
  static ThemingGetImageUseSvg valueOf(String name) =>
      _$valueOfThemingGetImageUseSvg(name);
  ...
  @BuiltValueSerializer(custom: true)
  static Serializer<ThemingGetImageUseSvg> get serializer =>
      const _$ThemingGetImageUseSvgSerializer();
}

class _$ThemingGetImageUseSvgSerializer
    implements PrimitiveSerializer<ThemingGetImageUseSvg> {
  const _$ThemingGetImageUseSvgSerializer();

  static const Map<ThemingGetImageUseSvg, Object> _toWire =
      <ThemingGetImageUseSvg, Object>{
    ThemingGetImageUseSvg.$0: 0,
    ThemingGetImageUseSvg.$1: 1,
  };

  static const Map<Object, ThemingGetImageUseSvg> _fromWire =
      <Object, ThemingGetImageUseSvg>{
...
abstract class ThemingGetManifestResponseApplicationJson_Icons
    implements
        ...
        Built<ThemingGetManifestResponseApplicationJson_Icons,
  ...
  // coverage:ignore-start
  factory ThemingGetManifestResponseApplicationJson_Icons.fromJson(
  ...
  static Serializer<ThemingGetManifestResponseApplicationJson_Icons>
      get serializer =>
          _$themingGetManifestResponseApplicationJsonIconsSerializer;

  @BuiltValueHook(finalizeBuilder: true)
  static void _validate(
    ThemingGetManifestResponseApplicationJson_IconsBuilder b,
  ) {
    _i5.checkMinLength(
      b.src,
      1,
...
abstract class ThemingGetManifestResponseApplicationJson
    implements
        ...
        Built<ThemingGetManifestResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory ThemingGetManifestResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
...
abstract class UserThemeEnableThemeResponseApplicationJson_Ocs
    implements
        ...
        Built<UserThemeEnableThemeResponseApplicationJson_Ocs,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserThemeEnableThemeResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserThemeEnableThemeResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class UserThemeEnableThemeResponseApplicationJson
    implements
        ...
        Built<UserThemeEnableThemeResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserThemeEnableThemeResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserThemeEnableThemeResponseApplicationJson>
      get serializer => _$userThemeEnableThemeResponseApplicationJsonSerializer;
}
...
abstract class UserThemeDisableThemeResponseApplicationJson_Ocs
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserThemeDisableThemeResponseApplicationJson_Ocs.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserThemeDisableThemeResponseApplicationJson_Ocs>
      get serializer =>
...
abstract class UserThemeDisableThemeResponseApplicationJson
    implements
        ...
        Built<UserThemeDisableThemeResponseApplicationJson,
  ...
  /// Use [toJson] to serialize it back into json.
  // coverage:ignore-start
  factory UserThemeDisableThemeResponseApplicationJson.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$jsonSerializers.deserializeWith(serializer, json)!;
  // coverage:ignore-end
  ...
  static Serializer<UserThemeDisableThemeResponseApplicationJson>
      get serializer =>
...
abstract class PublicCapabilities_Theming
  ...
  factory PublicCapabilities_Theming([
    void Function(PublicCapabilities_ThemingBuilder)? b,
  ...
  static Serializer<PublicCapabilities_Theming> get serializer =>
      _$publicCapabilitiesThemingSerializer;
}
...
abstract class PublicCapabilities
    implements
        $PublicCapabilitiesInterface,
        Built<PublicCapabilities, PublicCapabilitiesBuilder> {
  /// Creates a new PublicCapabilities object using the builder pattern.
  factory PublicCapabilities([void Function(PublicCapabilitiesBuilder)? b]) =
      _$PublicCapabilities;
  ...
  static Serializer<PublicCapabilities> get serializer =>
...
final Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..addBuilderFactory(
        const FullType(PublicCapabilities),
        PublicCapabilitiesBuilder.new,
      )
      ..add(PublicCapabilities.serializer)
      ..addBuilderFactory(
        const FullType(PublicCapabilities_Theming),
        PublicCapabilities_ThemingBuilder.new,
      )
