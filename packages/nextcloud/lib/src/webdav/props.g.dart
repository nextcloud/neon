...
void _$WebDavPropWithoutValuesBuildXmlChildren(
    WebDavPropWithoutValues instance, XmlBuilder builder,
  ...
  if (davgetlastmodifiedSerialized != null) {
    for (final value in davgetlastmodifiedSerialized) {
      builder.element('getlastmodified', namespace: 'DAV:', isSelfClosing: true,
          nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (davgetetagSerialized != null) {
    for (final value in davgetetagSerialized) {
      builder.element('getetag', namespace: 'DAV:', isSelfClosing: true,
          nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (davgetcontenttypeSerialized != null) {
    for (final value in davgetcontenttypeSerialized) {
      builder.element('getcontenttype', namespace: 'DAV:', isSelfClosing: true,
          nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (davgetcontentlengthSerialized != null) {
    for (final value in davgetcontentlengthSerialized) {
      builder.element('getcontentlength',
          namespace: 'DAV:', isSelfClosing: true, nest: () {
        if (value != null) {
          builder.text(value);
        }
      });
  ...
  if (davresourcetypeSerialized != null) {
    for (final value in davresourcetypeSerialized) {
      builder.element('resourcetype', namespace: 'DAV:', isSelfClosing: true,
          nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (ocidSerialized != null) {
    for (final value in ocidSerialized) {
      builder.element('id',
          namespace: 'http://owncloud.org/ns', isSelfClosing: true, nest: () {
        if (value != null) {
          builder.text(value);
        }
      });
  ...
  if (occommentscountSerialized != null) {
    for (final value in occommentscountSerialized) {
      builder.element('comments-count',
          namespace: 'http://owncloud.org/ns', isSelfClosing: true, nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (occommentsunreadSerialized != null) {
    for (final value in occommentsunreadSerialized) {
      builder.element('comments-unread',
          namespace: 'http://owncloud.org/ns', isSelfClosing: true, nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (ocownerdisplaynameSerialized != null) {
    for (final value in ocownerdisplaynameSerialized) {
      builder.element('owner-display-name',
          namespace: 'http://owncloud.org/ns', isSelfClosing: true, nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (ncnoteSerialized != null) {
    for (final value in ncnoteSerialized) {
      builder.element('note',
          namespace: 'http://nextcloud.org/ns', isSelfClosing: true, nest: () {
        if (value != null) {
          builder.text(value);
        }
      });
  ...
  if (ncdatafingerprintSerialized != null) {
    for (final value in ncdatafingerprintSerialized) {
      builder.element('data-fingerprint',
          namespace: 'http://nextcloud.org/ns', isSelfClosing: true, nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (ncrichworkspaceSerialized != null) {
    for (final value in ncrichworkspaceSerialized) {
      builder.element('rich-workspace',
          namespace: 'http://nextcloud.org/ns', isSelfClosing: true, nest: () {
        if (value != null) {
          builder.text(value);
        }
  ...
  if (ocssharepermissionsSerialized != null) {
    for (final value in ocssharepermissionsSerialized) {
      builder.element('share-permissions',
...
WebDavPropWithoutValues _$WebDavPropWithoutValuesFromXmlElement(
    XmlElement element) {
  final davgetlastmodified = element
      .getElements('getlastmodified', namespace: 'DAV:')
      ?.map((e) => e.getText())
      .whereType<String>();
  final davgetetag = element
      .getElements('getetag', namespace: 'DAV:')
      ?.map((e) => e.getText())
      .whereType<String>();
  final davgetcontenttype = element
      .getElements('getcontenttype', namespace: 'DAV:')
      ?.map((e) => e.getText())
      .whereType<String>();
  final davgetcontentlength = element
      .getElements('getcontentlength', namespace: 'DAV:')
      ?.map((e) => e.getText())
      .whereType<String>();
  final davresourcetype = element
      .getElements('resourcetype', namespace: 'DAV:')
      ?.map((e) => e.getText())
      .whereType<String>();
  final ocid = element
      .getElements('id', namespace: 'http://owncloud.org/ns')
      ?.map((e) => e.getText())
      .whereType<String>();
  final ocfileid = element
      .getElements('fileid', namespace: 'http://owncloud.org/ns')
      ?.map((e) => e.getText())
      .whereType<String>();
  final ocfavorite = element
      .getElements('favorite', namespace: 'http://owncloud.org/ns')
      ?.map((e) => e.getText())
      .whereType<String>();
  ...
  final ocdownloadurl = element
      ...
      ?.map((e) => e.getText())
      .whereType<String>();
  final ocownerid = element
      .getElements('owner-id', namespace: 'http://owncloud.org/ns')
      ?.map((e) => e.getText())
      .whereType<String>();
  final ocownerdisplayname = element
      ...
      ?.map((e) => e.getText())
      .whereType<String>();
  final ocsize = element
      .getElements('size', namespace: 'http://owncloud.org/ns')
      ?.map((e) => e.getText())
      .whereType<String>();
  final ocpermissions = element
      ...
      ?.map((e) => e.getText())
      .whereType<String>();
  final ncnote = element
      .getElements('note', namespace: 'http://nextcloud.org/ns')
      ?.map((e) => e.getText())
      .whereType<String>();
...
List<XmlNode> _$WebDavPropWithoutValuesToXmlChildren(
  ...
  final davgetlastmodified = instance.davgetlastmodified;
  final davgetlastmodifiedSerialized = davgetlastmodified;
  final davgetlastmodifiedConstructed = davgetlastmodifiedSerialized?.map((e) =>
      XmlElement(XmlName('getlastmodified', namespaces['DAV:']), [],
          e != null ? [XmlText(e)] : [], true));
  if (davgetlastmodifiedConstructed != null) {
    children.addAll(davgetlastmodifiedConstructed);
  }
  final davgetetag = instance.davgetetag;
  final davgetetagSerialized = davgetetag;
  final davgetetagConstructed = davgetetagSerialized?.map((e) => XmlElement(
      XmlName('getetag', namespaces['DAV:']),
      [],
      e != null ? [XmlText(e)] : [],
      true));
  ...
  final davgetcontenttype = instance.davgetcontenttype;
  final davgetcontenttypeSerialized = davgetcontenttype;
  final davgetcontenttypeConstructed = davgetcontenttypeSerialized?.map((e) =>
      XmlElement(XmlName('getcontenttype', namespaces['DAV:']), [],
          e != null ? [XmlText(e)] : [], true));
  ...
  final davgetcontentlengthConstructed = davgetcontentlengthSerialized?.map(
      (e) => XmlElement(XmlName('getcontentlength', namespaces['DAV:']), [],
          e != null ? [XmlText(e)] : [], true));
  ...
  final davresourcetype = instance.davresourcetype;
  final davresourcetypeSerialized = davresourcetype;
  final davresourcetypeConstructed = davresourcetypeSerialized?.map((e) =>
      XmlElement(XmlName('resourcetype', namespaces['DAV:']), [],
          e != null ? [XmlText(e)] : [], true));
  ...
  final ocid = instance.ocid;
  final ocidSerialized = ocid;
  final ocidConstructed = ocidSerialized?.map((e) => XmlElement(
      XmlName('id', namespaces['http://owncloud.org/ns']),
      [],
      e != null ? [XmlText(e)] : [],
      true));
  ...
  final ocfileid = instance.ocfileid;
  final ocfileidSerialized = ocfileid;
  final ocfileidConstructed = ocfileidSerialized?.map((e) => XmlElement(
      XmlName('fileid', namespaces['http://owncloud.org/ns']),
      [],
      e != null ? [XmlText(e)] : [],
      true));
  ...
  final ocfavorite = instance.ocfavorite;
  final ocfavoriteSerialized = ocfavorite;
  final ocfavoriteConstructed = ocfavoriteSerialized?.map((e) => XmlElement(
      XmlName('favorite', namespaces['http://owncloud.org/ns']),
      [],
      e != null ? [XmlText(e)] : [],
      true));
  ...
  final occommentshref = instance.occommentshref;
  final occommentshrefSerialized = occommentshref;
  final occommentshrefConstructed = occommentshrefSerialized?.map((e) =>
  ...
  final occommentscount = instance.occommentscount;
  final occommentscountSerialized = occommentscount;
  final occommentscountConstructed = occommentscountSerialized?.map((e) =>
      XmlElement(
  ...
  final occommentsunread = instance.occommentsunread;
  final occommentsunreadSerialized = occommentsunread;
  final occommentsunreadConstructed = occommentsunreadSerialized?.map((e) =>
      XmlElement(
  ...
  final ocdownloadurl = instance.ocdownloadurl;
  final ocdownloadurlSerialized = ocdownloadurl;
  final ocdownloadurlConstructed = ocdownloadurlSerialized?.map((e) =>
  ...
  final ocownerid = instance.ocownerid;
  final ocowneridSerialized = ocownerid;
  final ocowneridConstructed = ocowneridSerialized?.map((e) => XmlElement(
      XmlName('owner-id', namespaces['http://owncloud.org/ns']),
      [],
      e != null ? [XmlText(e)] : [],
      true));
  ...
  final ocownerdisplayname = instance.ocownerdisplayname;
  final ocownerdisplaynameSerialized = ocownerdisplayname;
  final ocownerdisplaynameConstructed = ocownerdisplaynameSerialized?.map((e) =>
      XmlElement(
  ...
  final ocsize = instance.ocsize;
  final ocsizeSerialized = ocsize;
  final ocsizeConstructed = ocsizeSerialized?.map((e) => XmlElement(
      XmlName('size', namespaces['http://owncloud.org/ns']),
      [],
      e != null ? [XmlText(e)] : [],
      true));
  ...
  final ocpermissions = instance.ocpermissions;
  final ocpermissionsSerialized = ocpermissions;
  final ocpermissionsConstructed = ocpermissionsSerialized?.map((e) =>
  ...
  final ncnote = instance.ncnote;
  final ncnoteSerialized = ncnote;
  final ncnoteConstructed = ncnoteSerialized?.map((e) => XmlElement(
      XmlName('note', namespaces['http://nextcloud.org/ns']),
      [],
      e != null ? [XmlText(e)] : [],
      true));
  ...
  final ncdatafingerprint = instance.ncdatafingerprint;
  final ncdatafingerprintSerialized = ncdatafingerprint;
  final ncdatafingerprintConstructed = ncdatafingerprintSerialized?.map((e) =>
      XmlElement(
  ...
  final ncisencrypted = instance.ncisencrypted;
  final ncisencryptedSerialized = ncisencrypted;
  final ncisencryptedConstructed = ncisencryptedSerialized?.map((e) =>
  ...
  final ncmetadataetag = instance.ncmetadataetag;
  final ncmetadataetagSerialized = ncmetadataetag;
  final ncmetadataetagConstructed = ncmetadataetagSerialized?.map((e) =>
      XmlElement(
          XmlName('metadata_etag', namespaces['http://nextcloud.org/ns']),
          [],
          e != null ? [XmlText(e)] : [],
          true));
  ...
  final nccreationtime = instance.nccreationtime;
  final nccreationtimeSerialized = nccreationtime;
  final nccreationtimeConstructed = nccreationtimeSerialized?.map((e) =>
      XmlElement(
  ...
  final ncrichworkspace = instance.ncrichworkspace;
  final ncrichworkspaceSerialized = ncrichworkspace;
  final ncrichworkspaceConstructed = ncrichworkspaceSerialized?.map((e) =>
      XmlElement(
  ...
  final ocssharepermissionsConstructed = ocssharepermissionsSerialized?.map(
      (e) => XmlElement(
          XmlName('share-permissions',
              namespaces['http://open-collaboration-services.org/ns']),
          [],
          e != null ? [XmlText(e)] : [],
          true));
  ...
  final ocmsharepermissionsConstructed = ocmsharepermissionsSerialized?.map(
      (e) => XmlElement(
          XmlName(
              'share-permissions', namespaces['http://open-cloud-mesh.org/ns']),
          [],
          e != null ? [XmlText(e)] : [],
          true));
...
mixin _$WebDavPropWithoutValuesXmlSerializableMixin {
  void buildXmlChildren(XmlBuilder builder,
          {Map<String, String> namespaces = const {}}) =>
      _$WebDavPropWithoutValuesBuildXmlChildren(
          this as WebDavPropWithoutValues, builder,
          namespaces: namespaces);

  void buildXmlElement(XmlBuilder builder,
          {Map<String, String> namespaces = const {}}) =>
      _$WebDavPropWithoutValuesBuildXmlElement(
          this as WebDavPropWithoutValues, builder,
          namespaces: namespaces);

  List<XmlAttribute> toXmlAttributes(
          {Map<String, String?> namespaces = const {}}) =>
      _$WebDavPropWithoutValuesToXmlAttributes(this as WebDavPropWithoutValues,
          namespaces: namespaces);

  List<XmlNode> toXmlChildren({Map<String, String?> namespaces = const {}}) =>
      _$WebDavPropWithoutValuesToXmlChildren(this as WebDavPropWithoutValues,
          namespaces: namespaces);

  XmlElement toXmlElement({Map<String, String?> namespaces = const {}}) =>
      _$WebDavPropWithoutValuesToXmlElement(this as WebDavPropWithoutValues,
          namespaces: namespaces);
}
...
void _$WebDavPropBuildXmlChildren(WebDavProp instance, XmlBuilder builder,
  ...
  if (davresourcetypeSerialized != null) {
    builder.element('resourcetype', namespace: 'DAV:', nest: () {
      davresourcetypeSerialized.buildXmlChildren(builder,
          namespaces: namespaces);
    });
  }
  final ocid = instance.ocid;
  ...
  final occommentshrefSerialized = occommentshref;
  if (occommentshrefSerialized != null) {
    builder.element('comments-href', namespace: 'http://owncloud.org/ns',
        nest: () {
  ...
  if (occommentscountSerialized != null) {
    builder.element('comments-count', namespace: 'http://owncloud.org/ns',
        nest: () {
  ...
  if (occommentsunreadSerialized != null) {
    builder.element('comments-unread', namespace: 'http://owncloud.org/ns',
        nest: () {
  ...
  final ocdownloadurlSerialized = ocdownloadurl;
  if (ocdownloadurlSerialized != null) {
    builder.element('downloadURL', namespace: 'http://owncloud.org/ns',
        nest: () {
  ...
  final ocownerdisplaynameSerialized = ocownerdisplayname;
  if (ocownerdisplaynameSerialized != null) {
    builder.element('owner-display-name', namespace: 'http://owncloud.org/ns',
        nest: () {
  ...
  final ocpermissionsSerialized = ocpermissions;
  if (ocpermissionsSerialized != null) {
    builder.element('permissions', namespace: 'http://owncloud.org/ns',
        nest: () {
  ...
  final ncdatafingerprintSerialized = ncdatafingerprint;
  if (ncdatafingerprintSerialized != null) {
    builder.element('data-fingerprint', namespace: 'http://nextcloud.org/ns',
        nest: () {
  ...
  final nchaspreviewSerialized = nchaspreview != null
      ...
      : null;
  if (nchaspreviewSerialized != null) {
    builder.element('has-preview', namespace: 'http://nextcloud.org/ns',
        nest: () {
  ...
  final ncmounttypeSerialized = ncmounttype;
  if (ncmounttypeSerialized != null) {
    builder.element('mount-type', namespace: 'http://nextcloud.org/ns',
        nest: () {
  ...
  if (ncisencryptedSerialized != null) {
    builder.element('is-encrypted', namespace: 'http://nextcloud.org/ns',
        nest: () {
  ...
  final ncmetadataetagSerialized = ncmetadataetag;
  if (ncmetadataetagSerialized != null) {
    builder.element('metadata_etag', namespace: 'http://nextcloud.org/ns',
        nest: () {
  ...
  if (ncuploadtimeSerialized != null) {
    builder.element('upload_time', namespace: 'http://nextcloud.org/ns',
        nest: () {
  ...
  if (nccreationtimeSerialized != null) {
    builder.element('creation_time', namespace: 'http://nextcloud.org/ns',
        nest: () {
  ...
  final ncrichworkspaceSerialized = ncrichworkspace;
  if (ncrichworkspaceSerialized != null) {
    builder.element('rich-workspace', namespace: 'http://nextcloud.org/ns',
        nest: () {
  ...
  if (ocssharepermissionsSerialized != null) {
    builder.element('share-permissions',
        namespace: 'http://open-collaboration-services.org/ns', nest: () {
  ...
  if (ocmsharepermissionsSerialized != null) {
    builder.element('share-permissions',
        namespace: 'http://open-cloud-mesh.org/ns', nest: () {
      builder.text(ocmsharepermissionsSerialized);
    });
  }
}

void _$WebDavPropBuildXmlElement(WebDavProp instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('prop', namespace: 'DAV:', namespaces: namespaces, nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
...
WebDavProp _$WebDavPropFromXmlElement(XmlElement element) {
  final davgetlastmodified =
      element.getElement('getlastmodified', namespace: 'DAV:')?.getText();
  final davgetetag =
      element.getElement('getetag', namespace: 'DAV:')?.getText();
  final davgetcontenttype =
      element.getElement('getcontenttype', namespace: 'DAV:')?.getText();
  final davgetcontentlength =
      element.getElement('getcontentlength', namespace: 'DAV:')?.getText();
  final davresourcetype = element.getElement('resourcetype', namespace: 'DAV:');
  final ocid =
      element.getElement('id', namespace: 'http://owncloud.org/ns')?.getText();
  final ocfileid = element
      .getElement('fileid', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final ocfavorite = element
      .getElement('favorite', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final occommentshref = element
      .getElement('comments-href', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final occommentscount = element
      .getElement('comments-count', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final occommentsunread = element
      .getElement('comments-unread', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final ocdownloadurl = element
      .getElement('downloadURL', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final ocownerid = element
      .getElement('owner-id', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final ocownerdisplayname = element
      .getElement('owner-display-name', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final ocsize = element
      .getElement('size', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final ocpermissions = element
      .getElement('permissions', namespace: 'http://owncloud.org/ns')
      ?.getText();
  final ncnote = element
      .getElement('note', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final ncdatafingerprint = element
      .getElement('data-fingerprint', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final nchaspreview = element
      .getElement('has-preview', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final ncmounttype = element
      .getElement('mount-type', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final ncisencrypted = element
      .getElement('is-encrypted', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final ncmetadataetag = element
      .getElement('metadata_etag', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final ncuploadtime = element
      .getElement('upload_time', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final nccreationtime = element
      .getElement('creation_time', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final ncrichworkspace = element
      .getElement('rich-workspace', namespace: 'http://nextcloud.org/ns')
      ?.getText();
  final ocssharepermissions = element
      .getElement('share-permissions',
          namespace: 'http://open-collaboration-services.org/ns')
      ?.getText();
  final ocmsharepermissions = element
      .getElement('share-permissions',
  ...
  return WebDavProp(
      ...
      davgetcontentlength:
          davgetcontentlength != null ? int.parse(davgetcontentlength) : null,
      davresourcetype: davresourcetype != null
          ? WebDavResourcetype.fromXmlElement(davresourcetype)
          : null,
      ocid: ocid,
      ocfileid: ocfileid,
      ...
      occommentscount:
          occommentscount != null ? int.parse(occommentscount) : null,
      occommentsunread:
          occommentsunread != null ? int.parse(occommentsunread) : null,
      ...
      ocssharepermissions:
          ocssharepermissions != null ? int.parse(ocssharepermissions) : null,
      ocmsharepermissions: ocmsharepermissions);
}

List<XmlAttribute> _$WebDavPropToXmlAttributes(WebDavProp instance,
    {Map<String, String?> namespaces = const {}}) {
  final attributes = <XmlAttribute>[];
  return attributes;
}

List<XmlNode> _$WebDavPropToXmlChildren(WebDavProp instance,
    {Map<String, String?> namespaces = const {}}) {
  final children = <XmlNode>[];
  final davgetlastmodified = instance.davgetlastmodified;
  final davgetlastmodifiedSerialized = davgetlastmodified;
  final davgetlastmodifiedConstructed = davgetlastmodifiedSerialized != null
      ? XmlElement(XmlName('getlastmodified', namespaces['DAV:']), [],
          [XmlText(davgetlastmodifiedSerialized)])
      : null;
  if (davgetlastmodifiedConstructed != null) {
  ...
  final davgetetagConstructed = davgetetagSerialized != null
      ? XmlElement(XmlName('getetag', namespaces['DAV:']), [],
          [XmlText(davgetetagSerialized)])
      : null;
  if (davgetetagConstructed != null) {
  ...
  final davgetcontenttypeConstructed = davgetcontenttypeSerialized != null
      ? XmlElement(XmlName('getcontenttype', namespaces['DAV:']), [],
          [XmlText(davgetcontenttypeSerialized)])
      : null;
  if (davgetcontenttypeConstructed != null) {
  ...
  final davgetcontentlengthConstructed = davgetcontentlengthSerialized != null
      ? XmlElement(XmlName('getcontentlength', namespaces['DAV:']), [],
          [XmlText(davgetcontentlengthSerialized)])
      : null;
  if (davgetcontentlengthConstructed != null) {
  ...
  final ocidConstructed = ocidSerialized != null
      ? XmlElement(XmlName('id', namespaces['http://owncloud.org/ns']), [],
          [XmlText(ocidSerialized)])
      : null;
  if (ocidConstructed != null) {
  ...
  final ocfileidConstructed = ocfileidSerialized != null
      ? XmlElement(XmlName('fileid', namespaces['http://owncloud.org/ns']), [],
          [XmlText(ocfileidSerialized)])
      : null;
  if (ocfileidConstructed != null) {
  ...
  final ocfavoriteConstructed = ocfavoriteSerialized != null
      ? XmlElement(XmlName('favorite', namespaces['http://owncloud.org/ns']),
          [], [XmlText(ocfavoriteSerialized)])
      : null;
  if (ocfavoriteConstructed != null) {
  ...
  final ocowneridConstructed = ocowneridSerialized != null
      ? XmlElement(XmlName('owner-id', namespaces['http://owncloud.org/ns']),
          [], [XmlText(ocowneridSerialized)])
      : null;
  if (ocowneridConstructed != null) {
  ...
  final ocsizeConstructed = ocsizeSerialized != null
      ? XmlElement(XmlName('size', namespaces['http://owncloud.org/ns']), [],
          [XmlText(ocsizeSerialized)])
      : null;
  if (ocsizeConstructed != null) {
  ...
  final ncnoteConstructed = ncnoteSerialized != null
      ? XmlElement(XmlName('note', namespaces['http://nextcloud.org/ns']), [],
          [XmlText(ncnoteSerialized)])
      : null;
  if (ncnoteConstructed != null) {
  ...
  final ncmetadataetagConstructed = ncmetadataetagSerialized != null
      ? XmlElement(
          XmlName('metadata_etag', namespaces['http://nextcloud.org/ns']),
          [],
          [XmlText(ncmetadataetagSerialized)])
      : null;
  if (ncmetadataetagConstructed != null) {
  ...
  final ncuploadtimeConstructed = ncuploadtimeSerialized != null
      ? XmlElement(
          XmlName('upload_time', namespaces['http://nextcloud.org/ns']),
          [],
          [XmlText(ncuploadtimeSerialized)])
      : null;
  if (ncuploadtimeConstructed != null) {
  ...
  final nccreationtimeConstructed = nccreationtimeSerialized != null
      ? XmlElement(
          XmlName('creation_time', namespaces['http://nextcloud.org/ns']),
          [],
          [XmlText(nccreationtimeSerialized)])
      : null;
  if (nccreationtimeConstructed != null) {
...
XmlElement _$WebDavPropToXmlElement(WebDavProp instance,
    {Map<String, String?> namespaces = const {}}) {
  return XmlElement(
      XmlName('prop', namespaces['DAV:']),
      [
...
mixin _$WebDavPropXmlSerializableMixin {
  void buildXmlChildren(XmlBuilder builder,
          {Map<String, String> namespaces = const {}}) =>
      _$WebDavPropBuildXmlChildren(this as WebDavProp, builder,
          namespaces: namespaces);

  void buildXmlElement(XmlBuilder builder,
          {Map<String, String> namespaces = const {}}) =>
      _$WebDavPropBuildXmlElement(this as WebDavProp, builder,
          namespaces: namespaces);
...
void _$WebDavOcFilterRulesBuildXmlChildren(
    WebDavOcFilterRules instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  final davgetlastmodified = instance.davgetlastmodified;
  final davgetlastmodifiedSerialized = davgetlastmodified;
  if (davgetlastmodifiedSerialized != null) {
...
void _$WebDavOcFilterRulesBuildXmlElement(
    WebDavOcFilterRules instance, XmlBuilder builder,
    {Map<String, String> namespaces = const {}}) {
  builder.element('filter-rules',
      namespace: 'http://owncloud.org/ns', namespaces: namespaces, nest: () {
    instance.buildXmlChildren(builder, namespaces: namespaces);
  });
}
...
mixin _$WebDavOcFilterRulesXmlSerializableMixin {
  void buildXmlChildren(XmlBuilder builder,
          {Map<String, String> namespaces = const {}}) =>
      _$WebDavOcFilterRulesBuildXmlChildren(
          this as WebDavOcFilterRules, builder,
          namespaces: namespaces);

  void buildXmlElement(XmlBuilder builder,
          {Map<String, String> namespaces = const {}}) =>
      _$WebDavOcFilterRulesBuildXmlElement(this as WebDavOcFilterRules, builder,
          namespaces: namespaces);

  List<XmlAttribute> toXmlAttributes(
          {Map<String, String?> namespaces = const {}}) =>
      _$WebDavOcFilterRulesToXmlAttributes(this as WebDavOcFilterRules,
          namespaces: namespaces);

  List<XmlNode> toXmlChildren({Map<String, String?> namespaces = const {}}) =>
      _$WebDavOcFilterRulesToXmlChildren(this as WebDavOcFilterRules,
          namespaces: namespaces);

  XmlElement toXmlElement({Map<String, String?> namespaces = const {}}) =>
      _$WebDavOcFilterRulesToXmlElement(this as WebDavOcFilterRules,
          namespaces: namespaces);
}
