...
class FilesDetailsPage extends StatelessWidget {
  const FilesDetailsPage({required this.bloc, required this.details, super.key});
          ...
          children: [
            ColoredBox(
              ...
              child: FilePreview(
                ...
                size: Size(MediaQuery.of(context).size.width, MediaQuery.of(context).size.height / 4),
              ),
            ),
            DataTable(
              headingRowHeight: 0,
                ...
                for (final entry
                    in {
                      details.isDirectory
                              ...
                              : FilesLocalizations.of(context).detailsFileName:
                          details.name,
                      ...
                      if (details.isFavorite != null) ...{
                        FilesLocalizations.of(context).detailsIsFavorite:
                            details.isFavorite!
                                ? NeonLocalizations.of(context).actionYes
                                : NeonLocalizations.of(context).actionNo,
                      },
                    }.entries)
                  DataRow(cells: [DataCell(Text(entry.key)), DataCell(Text(entry.value))]),
              ],
            ),
          ],
        ),
