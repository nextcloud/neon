...
class ServerTheme extends ThemeExtension<ServerTheme> {
  ...
  const ServerTheme({required this.nextcloudTheme});

  /// The theme that is configured on the server.
  final core.ThemingPublicCapabilities_Theming? nextcloudTheme;

  @override
  ServerTheme copyWith({core.ThemingPublicCapabilities_Theming? nextcloudTheme}) =>
      ServerTheme(nextcloudTheme: nextcloudTheme);
  ...
  ServerTheme lerp(ServerTheme? other, double t) {
    ...
    return ServerTheme(nextcloudTheme: nextcloudTheme);
  }

  @override
  int get hashCode => Object.hashAll([nextcloudTheme]);
