...
abstract final class AdaptiveIcons {
  ...
  static IconData get search =>
      !isCupertinoPlatform() ? Icons.search : CupertinoIcons.search;
  ...
  static IconData get settings =>
      !isCupertinoPlatform() ? Icons.settings : CupertinoIcons.settings;
  ...
  static IconData get add_account => !isCupertinoPlatform()
  ...
  static IconData get qr_code_scanner => !isCupertinoPlatform()
  ...
  static IconData get close =>
      !isCupertinoPlatform() ? Icons.close : CupertinoIcons.clear;
  ...
  static IconData get error => !isCupertinoPlatform()
      ? Icons.error
  ...
  static IconData get error_outline => !isCupertinoPlatform()
      ? Icons.error_outline
  ...
  static IconData get edit =>
      !isCupertinoPlatform() ? Icons.edit : CupertinoIcons.pen;
  ...
  static IconData get check =>
      !isCupertinoPlatform() ? Icons.check : CupertinoIcons.checkmark_alt;
  ...
  static IconData get check_circle => !isCupertinoPlatform()
      ? Icons.check_circle
  ...
  static IconData get cancel_outlined => !isCupertinoPlatform()
  ...
  static IconData get add =>
      !isCupertinoPlatform() ? Icons.add : CupertinoIcons.add;
  ...
  static IconData get tag =>
      !isCupertinoPlatform() ? MdiIcons.tag : CupertinoIcons.tag_fill;
  ...
  static IconData get email =>
      !isCupertinoPlatform() ? MdiIcons.email : CupertinoIcons.envelope_fill;
  ...
  static IconData get email_mark_as_unread => !isCupertinoPlatform()
  ...
  static IconData get folder =>
      !isCupertinoPlatform() ? MdiIcons.folder : CupertinoIcons.folder_fill;
  ...
  static IconData get star =>
      !isCupertinoPlatform() ? Icons.star : CupertinoIcons.star_fill;
  ...
  static IconData get star_outline =>
      !isCupertinoPlatform() ? Icons.star_outline : CupertinoIcons.star;
  ...
  static IconData get question_mark =>
      !isCupertinoPlatform() ? Icons.question_mark : CupertinoIcons.question;
  ...
  static IconData get visibility =>
      !isCupertinoPlatform() ? Icons.visibility : CupertinoIcons.eye_fill;
  ...
  static IconData get house =>
      !isCupertinoPlatform() ? Icons.house : CupertinoIcons.house_fill;
  ...
  static IconData get chevron_right => !isCupertinoPlatform()
      ? Icons.chevron_right
  ...
  static IconData get newspaper =>
      !isCupertinoPlatform() ? Icons.newspaper : CupertinoIcons.news_solid;
  ...
  static IconData get group =>
      !isCupertinoPlatform() ? Icons.group : CupertinoIcons.group_solid;
  ...
  static IconData get link =>
      !isCupertinoPlatform() ? Icons.link : CupertinoIcons.link;

  /// Platform-adaptive icon for
  /// <i class="material-icons md-36">text_snippet_outlined</i> &#x2014; material icon named "text_snippet_outlined"
  /// and <i class='cupertino-icons md-36'>news_solid</i> &#x2014; cupertino icon named "news_solid".
  static IconData get text_snippet_outlined => !isCupertinoPlatform()
  ...
  static IconData get lock =>
      !isCupertinoPlatform() ? Icons.lock : CupertinoIcons.padlock_solid;
  ...
  static IconData get edit_note =>
      !isCupertinoPlatform() ? Icons.edit_note : CupertinoIcons.create;
  ...
  static IconData get person =>
      !isCupertinoPlatform() ? Icons.person : CupertinoIcons.person;
  ...
  static IconData get automation =>
      !isCupertinoPlatform() ? MdiIcons.robot : CupertinoIcons.command;
}
