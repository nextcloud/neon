...
final sortBoxOrderOptionValues = <SortBoxOrder, LabelBuilder>{
  SortBoxOrder.ascending: (context) =>
      NeonLocalizations.of(context).optionsSortOrderAscending,
  SortBoxOrder.descending: (context) =>
      NeonLocalizations.of(context).optionsSortOrderDescending,
};
