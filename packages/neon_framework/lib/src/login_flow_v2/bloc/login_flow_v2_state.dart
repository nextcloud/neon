...
sealed class LoginFlowV2State extends Equatable {
  ...
  const LoginFlowV2State({required this.serverURL});
...
final class LoginFlowV2StateInitial extends LoginFlowV2State {
  ...
  const LoginFlowV2StateInitial({required super.serverURL});
}
...
final class LoginFlowV2StatePolling extends LoginFlowV2State {
  ...
  const LoginFlowV2StatePolling({required super.serverURL, required this.loginEndpoint, required this.token});
  ...
  @override
  List<Object?> get props => [serverURL, loginEndpoint, token];
}
...
final class LoginFlowV2StateSuccess extends LoginFlowV2State {
  ...
  const LoginFlowV2StateSuccess({required super.serverURL, required this.credentials});
