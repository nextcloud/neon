...
class LoginQrCodeState extends Equatable {
  ...
  const LoginQrCodeState({this.credentials, this.invalid = false});
  ...
  LoginQrCodeState copyWith({Credentials? credentials, bool? invalid}) {
    return LoginQrCodeState(credentials: credentials ?? this.credentials, invalid: invalid ?? this.invalid);
  }

  @override
  List<Object?> get props => [credentials, invalid];
}
