...
mixin _$SettingsRoute on GoRouteData {
  static SettingsRoute _fromState(GoRouterState state) => SettingsRoute(
    initialCategory: _$convertMapValue(
      'initial-category',
      state.uri.queryParameters,
      _$SettingsCategoriesEnumMap._$fromName,
    ),
  );
...
mixin _$AppImplementationSettingsRoute on GoRouteData {
  static AppImplementationSettingsRoute _fromState(GoRouterState state) =>
      AppImplementationSettingsRoute(appid: state.pathParameters['appid']!);

  AppImplementationSettingsRoute get _self => this as AppImplementationSettingsRoute;

  @override
  String get location => GoRouteData.$location('/settings/apps/${Uri.encodeComponent(_self.appid)}');
...
mixin _$AccountSettingsRoute on GoRouteData {
  static AccountSettingsRoute _fromState(GoRouterState state) =>
      AccountSettingsRoute(accountID: state.pathParameters['accountID']!);

  AccountSettingsRoute get _self => this as AccountSettingsRoute;

  @override
  String get location => GoRouteData.$location('/settings/account/${Uri.encodeComponent(_self.accountID)}');
...
RouteBase get $loginRoute => GoRouteData.$route(path: '/login', name: 'login', factory: _$LoginRoute._fromState);
