...
sealed class LoginCheckAccountState extends Equatable {
  ...
  const LoginCheckAccountState({required this.credentials});
...
final class LoginCheckAccountStateLoading extends LoginCheckAccountState {
  ...
  const LoginCheckAccountStateLoading({required super.credentials});
}
...
final class LoginCheckAccountStateSuccess extends LoginCheckAccountState {
  ...
  const LoginCheckAccountStateSuccess({required super.credentials, required this.account});

  /// The account fetched from the server.
  final Account account;

  @override
  List<Object?> get props => [credentials, account];
}
...
final class LoginCheckAccountStateFailure extends LoginCheckAccountState {
  ...
  const LoginCheckAccountStateFailure({required super.credentials});
}
