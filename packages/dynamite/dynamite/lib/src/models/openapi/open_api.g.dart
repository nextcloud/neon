...
class _$OpenAPISerializer implements StructuredSerializer<OpenAPI> {
  ...
  Iterable<Object?> serialize(Serializers serializers, OpenAPI object,
    ...
    final result = <Object?>[
      ...
      'servers',
      serializers.serialize(object.servers,
    ...
    if (value != null) {
      result
        ..add('tags')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(BuiltSet, [FullType(Tag)])));
    }
      ...
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(
                BuiltMap, [FullType(String), FullType(PathItem)])));
    }
    return result;
  }
      ...
      switch (key) {
        ...
        case 'components':
          result.components.replace(serializers.deserialize(value,
              specifiedType: const FullType(Components))! as Components);
          break;
        case 'paths':
    ...
    try {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'OpenAPI', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
