  ...
  Iterable<Object?> serialize(Serializers serializers, Operation object,
    ...
    if (value != null) {
      result
        ..add('parameters')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(BuiltList, [FullType(Parameter)])));
    }
      ...
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(
                BuiltMap, [FullType(String), FullType(Response)])));
    }
      ...
      switch (key) {
        ...
        case 'parameters':
          result.parameters.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(BuiltList, [FullType(Parameter)]))!
              as BuiltList<Object?>);
          break;
        case 'requestBody':
          result.requestBody.replace(serializers.deserialize(value,
              specifiedType: const FullType(RequestBody))! as RequestBody);
          break;
        case 'responses':
...
class _$Operation extends Operation {
  ...
  _$Operation._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        deprecated, r'Operation', 'deprecated');
  }
    ...
    try {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'Operation', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
