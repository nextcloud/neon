...
class OpenAPIBuilder implements Builder {
  ...
  static final Version maxSupportedVersion =
      minSupportedVersion.incrementMajor();
    ...
    try {
      final spec = switch (inputId.extension) {
        ...
        '.yaml' => checkedYamlDecode(
            ...
            (m) => openapi.serializers
                .deserializeWith(openapi.OpenAPI.serializer, m)!,
          ),
      ...
      final output = Library((b) {
        ...
        if (state.hasResolvedBuiltTypes) {
          b.directives.add(
            Directive.part(
              p.basename(outputId.changeExtension('.g.dart').path),
            ),
          );
        }
