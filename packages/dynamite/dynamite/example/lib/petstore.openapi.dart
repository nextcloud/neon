...
class $Client extends _i1.DynamiteClient {
  ...
  _i3.Request $findPets_Request({
    ...
    final $tags = _$jsonSerializers.serialize(
      tags,
  ...
  Future<_i1.DynamiteResponse<BuiltList<Pet>, void>> findPets({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<BuiltList<Pet>, void>(_serializer)
            .convert(_response);
  ...
  _i3.Request $addPet_Request({required NewPet newPet}) {
    ...
    _request.body = json.encode(
      _$jsonSerializers.serialize(
        newPet,
        specifiedType: const FullType(NewPet),
      ),
    );
    return _request;
  }
  ...
  Future<_i1.DynamiteResponse<Pet, void>> addPet({
    ...
    final _rawResponse =
        await _i1.ResponseConverter<Pet, void>(_serializer).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
