...
class $Client extends _i1.DynamiteClient {
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<BuiltList<Pet>, void> $findPets_Serializer() => _i1.DynamiteSerializer<BuiltList<Pet>, void>(
  ...
  @_i2.experimental
  _i1.DynamiteRequest $findPets_Request({
  ...
  Future<_i1.DynamiteResponse<BuiltList<Pet>, void>> findPets({
    ...
    final serializer = $findPets_Serializer();
    final _rawResponse = await _i1.ResponseConverter<BuiltList<Pet>, void>(serializer).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }

  /// Builds a serializer to parse the response of [$addPet_Request].
  @_i2.experimental
  _i1.DynamiteSerializer<Pet, void> $addPet_Serializer() => _i1.DynamiteSerializer<Pet, void>(
  ...
  @_i2.experimental
  _i1.DynamiteRequest $addPet_Request({required NewPet newPet}) {
    const _path = '/pets';
    final _uri = Uri.parse('$baseURL$_path');
  ...
  Future<_i1.DynamiteResponse<Pet, void>> addPet({required NewPet newPet}) async {
    ...
    final serializer = $addPet_Serializer();
    final _rawResponse = await _i1.ResponseConverter<Pet, void>(serializer).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }

  /// Builds a serializer to parse the response of [$findPetById_Request].
  @_i2.experimental
  _i1.DynamiteSerializer<Pet, void> $findPetById_Serializer() => _i1.DynamiteSerializer<Pet, void>(
        bodyType: const FullType(Pet),
        headersType: null,
        serializers: _$jsonSerializers,
      );
  ...
  @_i2.experimental
  _i1.DynamiteRequest $findPetById_Request({required int id}) {
    final _parameters = <String, Object?>{};
  ...
  Future<_i1.DynamiteResponse<Pet, void>> findPetById({required int id}) async {
    ...
    final serializer = $findPetById_Serializer();
    final _rawResponse = await _i1.ResponseConverter<Pet, void>(serializer).convert(_response);
    return _i1.DynamiteResponse.fromRawResponse(_rawResponse);
  }
  ...
  @_i2.experimental
  _i1.DynamiteSerializer<void, void> $deletePet_Serializer() => _i1.DynamiteSerializer<void, void>(
        bodyType: null,
        headersType: null,
        serializers: _$jsonSerializers,
      );
  ...
  @_i2.experimental
  _i1.DynamiteRequest $deletePet_Request({required int id}) {
    final _parameters = <String, Object?>{};
    final $id = _$jsonSerializers.serialize(id, specifiedType: const FullType(int));
    _parameters['id'] = $id;
    ...
    final _path = _i3.UriTemplate('/pets/{id}').expand(_parameters);
    final _uri = Uri.parse('$baseURL$_path');
    final _request = _i1.DynamiteRequest('delete', _uri)..validStatuses = const {204};
    return _request;
  }
  ...
  Future<_i1.DynamiteResponse<void, void>> deletePet({required int id}) async {
    ...
    final serializer = $deletePet_Serializer();
