...
// in dynamite_end_to_end_test/test/http_client_mock.dart.
...
class _FakeHttpClientRequest_1 extends _i1.SmartFake implements _i2.HttpClientRequest {
...
class _FakeHttpClientResponse_4 extends _i1.SmartFake implements _i2.HttpClientResponse {
...
class _FakeStreamSubscription_7<T> extends _i1.SmartFake implements _i4.StreamSubscription<T> {
  ...
  _i4.Future<_i2.HttpClientRequest> open(
    ...
    String? path,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i4.Future<_i2.HttpClientRequest>.value(_FakeHttpClientRequest_1(
          this,
          Invocation.method(
            #open,
            [
        ...
        returnValueForMissingStub: _i4.Future<_i2.HttpClientRequest>.value(_FakeHttpClientRequest_1(
          this,
          Invocation.method(
            #open,
            [
...
class MockHttpClientRequest extends _i1.Mock implements _i2.HttpClientRequest {
  ...
  _i4.Future<_i2.HttpClientResponse> get done => (super.noSuchMethod(
        ...
        returnValue: _i4.Future<_i2.HttpClientResponse>.value(_FakeHttpClientResponse_4(
          this,
          Invocation.getter(#done),
        )),
        returnValueForMissingStub: _i4.Future<_i2.HttpClientResponse>.value(_FakeHttpClientResponse_4(
          this,
          Invocation.getter(#done),
        )),
  ...
  @override
  _i4.Future<dynamic> addStream(_i4.Stream<List<int>>? stream) => (super.noSuchMethod(
        Invocation.method(
          #addStream,
          [stream],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockHttpClientResponse extends _i1.Mock implements _i2.HttpClientResponse {
  @override
  ...
  @override
  _i2.HttpClientResponseCompressionState get compressionState => (super.noSuchMethod(
        Invocation.getter(#compressionState),
        returnValue: _i2.HttpClientResponseCompressionState.notCompressed,
        returnValueForMissingStub: _i2.HttpClientResponseCompressionState.notCompressed,
  ...
  @override
  _i4.Stream<List<int>> where(bool Function(List<int>)? test) => (super.noSuchMethod(
        Invocation.method(
          #where,
          [test],
        ),
  ...
  @override
  _i4.Stream<E> asyncMap<E>(_i4.FutureOr<E> Function(List<int>)? convert) => (super.noSuchMethod(
        Invocation.method(
          #asyncMap,
          [convert],
        ),
  ...
  @override
  _i4.Stream<E> asyncExpand<E>(_i4.Stream<E>? Function(List<int>)? convert) => (super.noSuchMethod(
        Invocation.method(
          #asyncExpand,
          [convert],
        ),
  ...
  @override
  _i4.Stream<S> expand<S>(Iterable<S> Function(List<int>)? convert) => (super.noSuchMethod(
        Invocation.method(
          #expand,
          [convert],
        ),
  ...
  @override
  _i4.Future<dynamic> pipe(_i4.StreamConsumer<List<int>>? streamConsumer) => (super.noSuchMethod(
        Invocation.method(
          #pipe,
          [streamConsumer],
        ),
  ...
  @override
  _i4.Stream<S> transform<S>(_i4.StreamTransformer<List<int>, S>? streamTransformer) => (super.noSuchMethod(
        Invocation.method(
          #transform,
          [streamTransformer],
        ),
  ...
  _i4.Future<String> join([String? separator = r'']) => (super.noSuchMethod(
        ...
        returnValueForMissingStub: _i4.Future<String>.value(_i5.dummyValue<String>(
          this,
          Invocation.method(
            #join,
            [separator],
  ...
  @override
  _i4.Future<void> forEach(void Function(List<int>)? action) => (super.noSuchMethod(
        Invocation.method(
          #forEach,
          [action],
        ),
  ...
  _i4.Future<List<List<int>>> toList() => (super.noSuchMethod(
        ...
        returnValueForMissingStub: _i4.Future<List<List<int>>>.value(<List<int>>[]),
  ...
  _i4.Future<Set<List<int>>> toSet() => (super.noSuchMethod(
        ...
        returnValueForMissingStub: _i4.Future<Set<List<int>>>.value(<List<int>>{}),
  ...
  @override
  _i4.Stream<List<int>> takeWhile(bool Function(List<int>)? test) => (super.noSuchMethod(
        Invocation.method(
          #takeWhile,
          [test],
        ),
  ...
  @override
  _i4.Stream<List<int>> skipWhile(bool Function(List<int>)? test) => (super.noSuchMethod(
        Invocation.method(
          #skipWhile,
          [test],
        ),
...
class MockHttpHeaders extends _i1.Mock implements _i2.HttpHeaders {
  ...
  @override
  set chunkedTransferEncoding(bool? _chunkedTransferEncoding) => super.noSuchMethod(
        Invocation.setter(
