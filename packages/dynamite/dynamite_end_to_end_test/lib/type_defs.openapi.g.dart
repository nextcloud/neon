...
class _$NestedRedirectSerializer
  ...
  NestedRedirect deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'redirect':
          result.redirect.replace(serializers.deserialize(value,
              specifiedType: const FullType(Base))! as Base);
          break;
        case 'redirectBaseType':
          result.redirectBaseType = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int?;
          break;
        case 'redirectEmptyType':
          result.redirectEmptyType = serializers.deserialize(value,
...
class _$Base extends Base {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Base')..add('attribute', attribute))
        .toString();
  }
}
...
class _$NestedRedirect extends NestedRedirect {
  ...
  _$NestedRedirect._(
      {this.redirect, this.redirectBaseType, this.redirectEmptyType})
      : super._();
    ...
    try {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'NestedRedirect', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
