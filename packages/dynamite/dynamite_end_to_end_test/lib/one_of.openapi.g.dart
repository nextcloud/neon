...
class _$ObjectOneOf0Serializer implements StructuredSerializer<ObjectOneOf0> {
  ...
  Iterable<Object?> serialize(Serializers serializers, ObjectOneOf0 object,
    ...
    final result = <Object?>[
      'attribute1-oneOf',
      serializers.serialize(object.attribute1OneOf,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'attribute1-oneOf':
          result.attribute1OneOf = serializers.deserialize(value,
...
class _$ObjectOneOf1Serializer implements StructuredSerializer<ObjectOneOf1> {
  ...
  Iterable<Object?> serialize(Serializers serializers, ObjectOneOf1 object,
    ...
    final result = <Object?>[
      'attribute2-oneOf',
      serializers.serialize(object.attribute2OneOf,
          specifiedType: const FullType(String)),
    ];
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'attribute2-oneOf':
          result.attribute2OneOf = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
      }
    }
...
class _$OneOfUnspecifiedArray0Serializer
  ...
  Iterable<Object?> serialize(
      Serializers serializers, OneOfUnspecifiedArray0 object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'attribute-oneOf',
      serializers.serialize(object.attributeOneOf,
...
class _$ObjectOneOf0 extends ObjectOneOf0 {
  ...
  _$ObjectOneOf0._({required this.attribute1OneOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attribute1OneOf, r'ObjectOneOf0', 'attribute1OneOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ObjectOneOf0')
          ..add('attribute1OneOf', attribute1OneOf))
        .toString();
  }
}
...
class _$ObjectOneOf1 extends ObjectOneOf1 {
  ...
  _$ObjectOneOf1._({required this.attribute2OneOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attribute2OneOf, r'ObjectOneOf1', 'attribute2OneOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ObjectOneOf1')
          ..add('attribute2OneOf', attribute2OneOf))
        .toString();
  }
}
...
class _$MixedOneOf1 extends MixedOneOf1 {
  ...
  _$MixedOneOf1._({required this.attributeOneOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attributeOneOf, r'MixedOneOf1', 'attributeOneOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MixedOneOf1')
...
class _$OneObjectOneOf0 extends OneObjectOneOf0 {
  ...
  _$OneObjectOneOf0._({required this.attributeOneOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attributeOneOf, r'OneObjectOneOf0', 'attributeOneOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OneObjectOneOf0')
          ..add('attributeOneOf', attributeOneOf))
        .toString();
  }
}
...
class _$OneOfUnspecifiedArray0 extends OneOfUnspecifiedArray0 {
  ...
  _$OneOfUnspecifiedArray0._({required this.attributeOneOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attributeOneOf, r'OneOfUnspecifiedArray0', 'attributeOneOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OneOfUnspecifiedArray0')
          ..add('attributeOneOf', attributeOneOf))
        .toString();
  }
}
...
class _$OneOfStringArray0 extends OneOfStringArray0 {
  ...
  _$OneOfStringArray0._({required this.attributeOneOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attributeOneOf, r'OneOfStringArray0', 'attributeOneOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OneOfStringArray0')
          ..add('attributeOneOf', attributeOneOf))
        .toString();
  }
}
