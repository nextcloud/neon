...
final BuiltSet<EnumString> _$enumStringValues =
    BuiltSet<EnumString>(const <EnumString>[
  _$enumStringTest,
...
final BuiltSet<EnumDynamic> _$enumDynamicValues =
    BuiltSet<EnumDynamic>(const <EnumDynamic>[
  _$enumDynamic$0,
  _$enumDynamicString,
  _$enumDynamic$false,
]);
...
class _$WrappedEnumSerializer implements StructuredSerializer<WrappedEnum> {
  ...
  Iterable<Object?> serialize(Serializers serializers, WrappedEnum object,
    ...
    final result = <Object?>[
      ...
      'integer',
      serializers.serialize(object.integer,
  ...
  EnumReference deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'string':
          result.string = serializers.deserialize(value,
              specifiedType: const FullType(EnumString))! as EnumString;
          break;
      }
    }
    ...
    final _$result = _$v ??
        _$WrappedEnum._(
            string: BuiltValueNullFieldError.checkNotNull(
                string, r'WrappedEnum', 'string'),
            integer: BuiltValueNullFieldError.checkNotNull(
                integer, r'WrappedEnum', 'integer'));
    replace(_$result);
    return _$result;
  }
}
...
class _$EnumReference extends EnumReference {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EnumReference')
          ..add('string', string))
        .toString();
  }
}
