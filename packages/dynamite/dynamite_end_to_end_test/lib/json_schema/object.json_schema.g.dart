...
part of 'object.json_schema.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ObjectJsonSchemaJson> _$objectJsonSchemaJsonSerializer = _$ObjectJsonSchemaJsonSerializer();

class _$ObjectJsonSchemaJsonSerializer implements StructuredSerializer<ObjectJsonSchemaJson> {
  @override
  final Iterable<Type> types = const [ObjectJsonSchemaJson, _$ObjectJsonSchemaJson];
  @override
  final String wireName = 'ObjectJsonSchemaJson';

  @override
  Iterable<Object?> serialize(Serializers serializers, ObjectJsonSchemaJson object,
  ...
  @override
  ObjectJsonSchemaJson deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = ObjectJsonSchemaJsonBuilder();
...
abstract mixin class $ObjectJsonSchemaJsonInterfaceBuilder {
  void replace($ObjectJsonSchemaJsonInterface other);
  void update(void Function($ObjectJsonSchemaJsonInterfaceBuilder) updates);
  bool? get $bool;
  set $bool(bool? $bool);
...
class _$ObjectJsonSchemaJson extends ObjectJsonSchemaJson {
  @override
  final bool? $bool;
  @override
  final int? integer;
  ...
  factory _$ObjectJsonSchemaJson([void Function(ObjectJsonSchemaJsonBuilder)? updates]) =>
      (ObjectJsonSchemaJsonBuilder()..update(updates))._build();

  _$ObjectJsonSchemaJson._(
      {this.$bool,
      this.integer,
      this.$double,
      this.$num,
  ...
  @override
  ObjectJsonSchemaJson rebuild(void Function(ObjectJsonSchemaJsonBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ObjectJsonSchemaJsonBuilder toBuilder() => ObjectJsonSchemaJsonBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ObjectJsonSchemaJson &&
        $bool == other.$bool &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ObjectJsonSchemaJson')
          ..add('\$bool', $bool)
          ..add('integer', integer)
          ..add('\$double', $double)
          ..add('\$num', $num)
...
class ObjectJsonSchemaJsonBuilder
    implements Builder<ObjectJsonSchemaJson, ObjectJsonSchemaJsonBuilder>, $ObjectJsonSchemaJsonInterfaceBuilder {
  _$ObjectJsonSchemaJson? _$v;
  ...
  ObjectJsonSchemaJsonBuilder() {
    ObjectJsonSchemaJson._defaults(this);
  }

  ObjectJsonSchemaJsonBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _$bool = $v.$bool;
      _integer = $v.integer;
  ...
  @override
  void replace(covariant ObjectJsonSchemaJson other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ObjectJsonSchemaJson;
  }

  @override
  void update(void Function(ObjectJsonSchemaJsonBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ObjectJsonSchemaJson build() => _build();

  _$ObjectJsonSchemaJson _build() {
    ObjectJsonSchemaJson._validate(this);
    _$ObjectJsonSchemaJson _$result;
    try {
      _$result = _$v ??
          _$ObjectJsonSchemaJson._(
              $bool: $bool,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(r'ObjectJsonSchemaJson', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
