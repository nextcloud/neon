...
class _$ObjectAnyOf0Serializer implements StructuredSerializer<ObjectAnyOf0> {
  ...
  Iterable<Object?> serialize(Serializers serializers, ObjectAnyOf0 object,
    ...
    final result = <Object?>[
      'attribute1-anyOf',
      serializers.serialize(object.attribute1AnyOf,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'attribute1-anyOf':
          result.attribute1AnyOf = serializers.deserialize(value,
...
class _$ObjectAnyOf1Serializer implements StructuredSerializer<ObjectAnyOf1> {
  ...
  Iterable<Object?> serialize(Serializers serializers, ObjectAnyOf1 object,
    ...
    final result = <Object?>[
      'attribute2-anyOf',
      serializers.serialize(object.attribute2AnyOf,
          specifiedType: const FullType(String)),
    ];
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'attribute2-anyOf':
          result.attribute2AnyOf = serializers.deserialize(value,
              specifiedType: const FullType(String))! as String;
          break;
      }
    }
...
class _$ObjectAnyOf0 extends ObjectAnyOf0 {
  ...
  _$ObjectAnyOf0._({required this.attribute1AnyOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attribute1AnyOf, r'ObjectAnyOf0', 'attribute1AnyOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ObjectAnyOf0')
          ..add('attribute1AnyOf', attribute1AnyOf))
        .toString();
  }
}
...
class _$ObjectAnyOf1 extends ObjectAnyOf1 {
  ...
  _$ObjectAnyOf1._({required this.attribute2AnyOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attribute2AnyOf, r'ObjectAnyOf1', 'attribute2AnyOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ObjectAnyOf1')
          ..add('attribute2AnyOf', attribute2AnyOf))
        .toString();
  }
}
...
class _$MixedAnyOf1 extends MixedAnyOf1 {
  ...
  _$MixedAnyOf1._({required this.attributeAnyOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attributeAnyOf, r'MixedAnyOf1', 'attributeAnyOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MixedAnyOf1')
...
class _$OneObjectAnyOf0 extends OneObjectAnyOf0 {
  ...
  _$OneObjectAnyOf0._({required this.attributeAnyOf}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attributeAnyOf, r'OneObjectAnyOf0', 'attributeAnyOf');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OneObjectAnyOf0')
          ..add('attributeAnyOf', attributeAnyOf))
        .toString();
  }
}
