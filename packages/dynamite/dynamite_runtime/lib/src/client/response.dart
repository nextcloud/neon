...
class ResponseConverter<B, H> with Converter<http.StreamedResponse, Future<DynamiteRawResponse<B, H>>> {
...
class RawResponseEncoder<B, H> with Converter<DynamiteRawResponse<B, H>, Map<String, Object?>> {
  @override
  Map<String, Object?> convert(DynamiteRawResponse<B, H> input) => {
        'statusCode': input.statusCode,
        'body': input.rawBody,
...
class RawResponseDecoder<B, H> with Converter<Map<String, Object?>, DynamiteResponse<B, H>> {
  /// Creates a new response converter
