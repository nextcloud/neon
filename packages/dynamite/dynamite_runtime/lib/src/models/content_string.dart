...
abstract class ContentString<T>
    implements Built<ContentString<T>, ContentStringBuilder<T>> {
  /// Creates a new content `String`.
  factory ContentString([void Function(ContentStringBuilder<T>)? b]) =
      _$ContentString<T>;
  ...
  static Serializer<ContentString<Object?>> get serializer =>
