...
TypeResultObject resolveObject(State state, json_schema.JsonSchema schema, {bool isHeader = false}) {
  final result = TypeResultObject(schema.identifier!, nullable: schema.nullable);
