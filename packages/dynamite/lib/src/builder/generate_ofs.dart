...
Iterable<Spec> generateSomeOf(TypeResultSomeOf result) sync* {
  ...
  final oneOfValidator = Method((b) {
    b
      ...
      ..lambda = true
      ..body =
          refer('validateOneOf', 'package:dynamite_runtime/utils.dart').call([refer('_values'), refer('_names')]).code;
  });
  ...
  final anyOfValidator = Method((b) {
    b
      ...
      ..lambda = true
      ..body =
          refer('validateAnyOf', 'package:dynamite_runtime/utils.dart').call([refer('_values'), refer('_names')]).code;
  });
