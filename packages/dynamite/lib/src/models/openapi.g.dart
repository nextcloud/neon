...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..addBuilderFactory(
            const FullType(BuiltMap, [FullType(String), FullType(SecurityScheme)]),
            () => MapBuilder<String, SecurityScheme>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltMap, [FullType(String), FullType(JsonSchema)]),
            () => MapBuilder<String, JsonSchema>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltMap, [FullType(String), FullType(ServerVariable)]),
