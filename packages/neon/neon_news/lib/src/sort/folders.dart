...
final foldersSortBox = SortBox<FoldersSortProperty, FolderFeedsWrapper>(
  properties: {
    FoldersSortProperty.alphabetical: (folderFeedsWrapper) =>
        folderFeedsWrapper.folder.name.toLowerCase(),
    FoldersSortProperty.unreadCount: (folderFeedsWrapper) =>
        folderFeedsWrapper.unreadCount,
  },
  boxes: const {
    FoldersSortProperty.alphabetical: {
      (
        property: FoldersSortProperty.unreadCount,
        order: SortBoxOrder.descending
      ),
    },
    FoldersSortProperty.unreadCount: {
      (
        property: FoldersSortProperty.alphabetical,
